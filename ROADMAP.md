...
**Базовий коміт аудиту:** M7.3-04 — sensor observation correlation DONE; NEXT = M7.3-05 (#129)
...
M7.1-03 DONE. M7.1-04 DONE. M7.1-05 DONE. M7.1-06 DONE. M7.1-07 DONE. M7.1-08 DONE. M7.1-09 DONE. M7.1-10 DONE. **M7.1-11 DONE. M7.1 CLOSED.** **M7.2-01 DONE.** **M7.2-02 DONE.** **M7.2-03 DONE.** **M7.2-04 DONE. M7.2 CLOSED.** **M7.3-01 DONE.** **M7.3-02 DONE.** **M7.3-03 DONE.** **M7.3-04 DONE.** Post-MVP M7 = **8** open (NEXT = M7.3-05 #129).
...
**NEXT = M7.3-05:** [M7.3-05](https://github.com/sesquicadaver/MTDirector/issues/129) Emit visibility_status / confidence on every assessment. **M7.3-04 DONE.**
...
**Кінець черги:** 8 відкритих атомарних задач (усі Post-MVP M7). Start here: #129 M7.3-05.
...
| Post-MVP M7 | 8 | NEXT = M7.3-05 (#129) |
| **Нереалізовано разом** | **12** | лише M7 |
| DONE у коді (§2.2) | 119 | …+M4-01…13+M6-01…M6-09+N1-07+M7.1-01…M7.1-11+M7.3-01…M7.3-04 |
...
58. Відкрити **M7.3-05** → [issue #129](https://github.com/sesquicadaver/MTDirector/issues/129).
