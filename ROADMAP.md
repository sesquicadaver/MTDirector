...
**Базовий коміт аудиту:** `main` @ post-CONT-01 — M7.4 CLOSED; P2 read + write CLOSED; Desktop alignment W1–W4 / W2.1–W2.2 DONE; CONT-01 DONE; **§3.C NEXT = CONT-02** (#341)
...
**Статус:** **§3.C active.** `NEXT = CONT-02` ([#341](https://github.com/sesquicadaver/MTDirector/issues/341)). CONT-01 **DONE** ([#340](https://github.com/sesquicadaver/MTDirector/issues/340)).  
...
| 135 | CONT-02 | [#341](https://github.com/sesquicadaver/MTDirector/issues/341) | Neighbor apply fills VRRP member b | OPEN — **NEXT** |
...
| §3.C Continuous | 4 | CONT-02 + W5-01…03 |
| **Нереалізовано (§3)** | **4** | CONT-02 is **NEXT** |
...
| Neighbor apply VRRP member b | CONT-02 | Add router Apply → `PairMemberB*` | OPEN (#341) — **NEXT** |
...
Оновлювати рядок **Статус** при закритті issue; **NEXT** = CONT-02 (#341). Закриття хвилі без засіяного наступного рядка — дефект процесу.
...
1. **NEXT = CONT-02** (#341). Береться лише відкритий рядок §3; лаба **не** блокує.
