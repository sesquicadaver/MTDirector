...
**Дата оновлення:** 5 вересня 2026 (W7-17 resolve-only zone UoW residual)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-17 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…17 DONE; **§3.C NEXT = W7-18 (#435)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 46 | 1 | CONT…SEC-15 + W7-01…17 **DONE**; **NEXT = W7-18** |
| **Разом (код)** | **171** | **0** | W7-17 resolve-only zone UoW residual |
| **Разом (черга §3)** | **175** | **1** | **NEXT = W7-18 (#435)** |
...
**Статус:** **§3.C NEXT = W7-18 (#435).** W7-17 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 180 | W7-18 | [#435](https://github.com/sesquicadaver/MTDirector/issues/435) | Lock Start* AddOperationAsync outside-UoW residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…17 — **DONE**; **NEXT = W7-18** |
...
| §3.C Continuous | 1 | W7-17 **DONE**; W7-18 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-18 (#435)** |
...
| Start* AddOperationAsync outside-UoW residual Living Spec | W7-18 | Lock known-limitations residual | **OPEN** (#435) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-18 (#435)**. W7-17 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-18 (#435)**. W7-17 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
