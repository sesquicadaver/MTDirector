...
**Дата оновлення:** 5 вересня 2026 (W7-21 IResponseFeedbackDeliveryPort not-configured residual)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-21 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…21 DONE; **§3.C NEXT = W7-22 (#443)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 50 | 1 | CONT…SEC-15 + W7-01…21 **DONE**; **NEXT = W7-22** |
| **Разом (код)** | **175** | **0** | W7-21 IResponseFeedbackDeliveryPort not-configured residual |
| **Разом (черга §3)** | **179** | **1** | **NEXT = W7-22 (#443)** |
...
**Статус:** **§3.C NEXT = W7-22 (#443).** W7-21 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 184 | W7-22 | [#443](https://github.com/sesquicadaver/MTDirector/issues/443) | Lock Desktop zip/tar installer packaging residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…21 — **DONE**; **NEXT = W7-22** |
...
| §3.C Continuous | 1 | W7-21 **DONE**; W7-22 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-22 (#443)** |
...
| Desktop zip/tar installer packaging residual Living Spec | W7-22 | Lock known-limitations residual | **OPEN** (#443) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-22 (#443)**. W7-21 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-22 (#443)**. W7-21 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
