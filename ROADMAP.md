...
**Дата оновлення:** 6 вересня 2026 (W7-36 continuous residual seed after Inventory Add router)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-36 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…36 DONE; **§3.C NEXT = W7-37 (#472)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 65 | 1 | CONT…SEC-15 + W7-01…36 **DONE**; **NEXT = W7-37** |
| **Разом (код)** | **190** | **0** | W7-36 continuous residual seed after Inventory Add router |
| **Разом (черга §3)** | **194** | **1** | **NEXT = W7-37 (#472)** |
...
**Статус:** **§3.C NEXT = W7-37 (#472).** W7-36 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 199 | W7-37 | [#472](https://github.com/sesquicadaver/MTDirector/issues/472) | Lock gRPC remains available for automation residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…36 — **DONE**; **NEXT = W7-37** |
...
| §3.C Continuous | 1 | W7-36 **DONE**; W7-37 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-37 (#472)** |
...
| gRPC remains available for automation residual Living Spec | W7-37 | Lock known-limitations residual | **OPEN** (#472) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-37 (#472)**. W7-36 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-37 (#472)**. W7-36 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
