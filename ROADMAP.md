...
**Дата оновлення:** 5 вересня 2026 (W7-12 Desktop AuthenticationFailed status Living Spec)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-12 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…12 DONE; **§3.C NEXT = W7-13 (#425)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 41 | 1 | CONT…SEC-15 + W7-01…12 **DONE**; **NEXT = W7-13** |
| **Разом (код)** | **166** | **0** | W7-12 Desktop AuthenticationFailed status Living Spec |
| **Разом (черга §3)** | **170** | **1** | **NEXT = W7-13 (#425)** |
...
**Статус:** **§3.C NEXT = W7-13 (#425).** W7-12 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 175 | W7-13 | [#425](https://github.com/sesquicadaver/MTDirector/issues/425) | mTLS map log includes request TraceIdentifier | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…12 — **DONE**; **NEXT = W7-13** |
...
| §3.C Continuous | 1 | W7-12 **DONE**; W7-13 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-13 (#425)** |
...
| mTLS map log TraceIdentifier | W7-13 | Correlate Connect with Controller logs | **OPEN** (#425) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-13 (#425)**. W7-12 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-13 (#425)**. W7-12 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
