...
**Дата оновлення:** 6 вересня 2026 (W7-35 Inventory Add router wizard DONE residual)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-35 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…35 DONE; **§3.C NEXT = W7-36 (#470)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 64 | 1 | CONT…SEC-15 + W7-01…35 **DONE**; **NEXT = W7-36** |
| **Разом (код)** | **189** | **0** | W7-35 Inventory Add router wizard DONE residual |
| **Разом (черга §3)** | **193** | **1** | **NEXT = W7-36 (#470)** |
...
**Статус:** **§3.C NEXT = W7-36 (#470).** W7-35 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 198 | W7-36 | [#470](https://github.com/sesquicadaver/MTDirector/issues/470) | Seed next continuous residual after Inventory Add router Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…35 — **DONE**; **NEXT = W7-36** |
...
| §3.C Continuous | 1 | W7-35 **DONE**; W7-36 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-36 (#470)** |
...
| Seed next continuous residual after Inventory Add router Living Spec | W7-36 | Seed §3.C next residual tranche | **OPEN** (#470) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-36 (#470)**. W7-35 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-36 (#470)**. W7-35 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
