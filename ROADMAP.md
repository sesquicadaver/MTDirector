...
**Дата оновлення:** 5 вересня 2026 (W7-05 Desktop actor from cert CN)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-05 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…05 DONE; **§3.C NEXT = W7-06 (#411)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 34 | 1 | CONT…SEC-15 + W7-01…05 **DONE**; **NEXT = W7-06** |
| **Разом (код)** | **159** | **0** | W7-05 Desktop actor from cert CN |
| **Разом (черга §3)** | **163** | **1** | **NEXT = W7-06 (#411)** |
...
**Статус:** **§3.C NEXT = W7-06 (#411).** W7-05 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 168 | W7-06 | [#411](https://github.com/sesquicadaver/MTDirector/issues/411) | Map mTLS client cert to HttpContext.User | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…05 — **DONE**; **NEXT = W7-06** |
...
| §3.C Continuous | 1 | W7-05 **DONE**; W7-06 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-06 (#411)** |
...
| mTLS → HttpContext.User | W7-06 | ClaimsPrincipal from client cert | **OPEN** (#411) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-06 (#411)**. W7-05 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-06 (#411)**. W7-05 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
