...
**Базовий коміт аудиту:** `main` @ post-W7-46 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…46 DONE; **§3.C NEXT = W7-47 (#492)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 75 | 1 | CONT…SEC-15 + W7-01…46 **DONE**; **NEXT = W7-47** |
| **Разом (код)** | **196** | **0** | W7-42 continuous residual seed after WriteEnabled |
| **Разом (черга §3)** | **204** | **1** | **NEXT = W7-47 (#492)** |
...
**Статус:** **§3.C NEXT = W7-47 (#492).** W7-46 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 209 | W7-47 | [#492](https://github.com/sesquicadaver/MTDirector/issues/492) | Lock SEC-07…SEC-15 DONE residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…46 — **DONE**; **NEXT = W7-47** |
...
| §3.C Continuous | 1 | W7-46 **DONE**; W7-47 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-47 (#492)** |
...
| SEC-07…SEC-15 DONE residual Living Spec | W7-47 | Lock known-limitations residual | **OPEN** (#492) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-47 (#492)**. W7-46 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-47 (#492)**. W7-46 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
