...
**Базовий коміт аудиту:** `main` @ post-W7-44 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…44 DONE; **§3.C NEXT = W7-45 (#488)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 73 | 1 | CONT…SEC-15 + W7-01…44 **DONE**; **NEXT = W7-45** |
| **Разом (код)** | **196** | **0** | W7-42 continuous residual seed after WriteEnabled |
| **Разом (черга §3)** | **202** | **1** | **NEXT = W7-45 (#488)** |
...
**Статус:** **§3.C NEXT = W7-45 (#488).** W7-44 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 207 | W7-45 | [#488](https://github.com/sesquicadaver/MTDirector/issues/488) | Lock M7.1…M7.4 CLOSED residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…44 — **DONE**; **NEXT = W7-45** |
...
| §3.C Continuous | 1 | W7-44 **DONE**; W7-45 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-45 (#488)** |
...
| M7.1…M7.4 CLOSED residual Living Spec | W7-45 | Lock known-limitations residual | **OPEN** (#488) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-45 (#488)**. W7-44 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-45 (#488)**. W7-44 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
