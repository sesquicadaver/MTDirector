...
**Базовий коміт аудиту:** M1-14 (routing/firewall-dependency discovery) — черга зсунута на M1-15
...
| M1 Read-only slice | 14 | 20 | 41% |
| N1 Packet-path weave | 0 | 7 | 0% |
| M2–M6 (решта MVP) | 0 | 58 | 0% |
| M7 Post-MVP | 0 | 27 | 0% |
| **Разом** | **24** | **112** | **~18% issues** |

MVP issues (109) = 24 done + **85 remaining** до MVP CLOSED.  
...
| Збірка | Стан |
|--------|------|
| `Mfc.RouterOs` | protocol + typed executor + discovery through routing deps (M1-06..14); next: VRRP |
...
**NEXT = черга #11:** [M1-15](https://github.com/sesquicadaver/MTDirector/issues/25).
...
| Remaining discovery | M1-15…17 | VRRP→capabilities | TODO #11 |
...
1. Відкрити **чергу #11** → [M1-15 / issue #25](https://github.com/sesquicadaver/MTDirector/issues/25).  
