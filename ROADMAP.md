...
**Дата оновлення:** 6 вересня 2026 (W7-39 RouterOs Enabled default fail-closed residual)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-39 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…39 DONE; **§3.C NEXT = W7-40 (#478)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 68 | 1 | CONT…SEC-15 + W7-01…39 **DONE**; **NEXT = W7-40** |
| **Разом (код)** | **193** | **0** | W7-39 RouterOs Enabled default fail-closed residual |
| **Разом (черга §3)** | **197** | **1** | **NEXT = W7-40 (#478)** |
...
**Статус:** **§3.C NEXT = W7-40 (#478).** W7-39 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 202 | W7-40 | [#478](https://github.com/sesquicadaver/MTDirector/issues/478) | Seed next continuous residual after RouterOs fail-closed Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…39 — **DONE**; **NEXT = W7-40** |
...
| §3.C Continuous | 1 | W7-39 **DONE**; W7-40 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-40 (#478)** |
...
| Seed next continuous residual after RouterOs fail-closed Living Spec | W7-40 | Seed §3.C next residual tranche | **OPEN** (#478) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-40 (#478)**. W7-39 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-40 (#478)**. W7-39 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
