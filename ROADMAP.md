...
**Дата оновлення:** 5 вересня 2026 (W7-27 Live CHR matrix OFF residual)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-27 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…27 DONE; **§3.C NEXT = W7-28 (#455)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 56 | 1 | CONT…SEC-15 + W7-01…27 **DONE**; **NEXT = W7-28** |
| **Разом (код)** | **181** | **0** | W7-27 Live CHR matrix OFF residual |
| **Разом (черга §3)** | **185** | **1** | **NEXT = W7-28 (#455)** |
...
**Статус:** **§3.C NEXT = W7-28 (#455).** W7-27 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 190 | W7-28 | [#455](https://github.com/sesquicadaver/MTDirector/issues/455) | Lock Golden live CHR hashes env-gated residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…27 — **DONE**; **NEXT = W7-28** |
...
| §3.C Continuous | 1 | W7-27 **DONE**; W7-28 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-28 (#455)** |
...
| Golden live CHR hashes env-gated residual Living Spec | W7-28 | Lock known-limitations residual | **OPEN** (#455) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-28 (#455)**. W7-27 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-28 (#455)**. W7-27 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
