...
**Дата оновлення:** 5 вересня 2026 (W7-24 CycloneDX-lite SBOM packaging residual)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-24 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…24 DONE; **§3.C NEXT = W7-25 (#449)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 53 | 1 | CONT…SEC-15 + W7-01…24 **DONE**; **NEXT = W7-25** |
| **Разом (код)** | **178** | **0** | W7-24 CycloneDX-lite SBOM packaging residual |
| **Разом (черга §3)** | **182** | **1** | **NEXT = W7-25 (#449)** |
...
**Статус:** **§3.C NEXT = W7-25 (#449).** W7-24 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 187 | W7-25 | [#449](https://github.com/sesquicadaver/MTDirector/issues/449) | Lock MVP scope-lock no-NAT/RAW writes residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…24 — **DONE**; **NEXT = W7-25** |
...
| §3.C Continuous | 1 | W7-24 **DONE**; W7-25 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-25 (#449)** |
...
| MVP scope-lock no-NAT/RAW writes residual Living Spec | W7-25 | Lock known-limitations residual | **OPEN** (#449) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-25 (#449)**. W7-24 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-25 (#449)**. W7-24 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
