...
**Дата оновлення:** 3 вересня 2026 (W7-02 gRPC actor ↔ principal)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-02 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…02 DONE; **§3.C NEXT = W7-03 (#404)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 31 | 1 | CONT…SEC-15 + W7-01…02 **DONE**; **NEXT = W7-03** |
| **Разом (код)** | **156** | **0** | W7-02 actor principal bind |
| **Разом (черга §3)** | **160** | **1** | **NEXT = W7-03 (#404)** |
...
**Статус:** **§3.C NEXT = W7-03 (#404).** W7-02 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 165 | W7-03 | [#404](https://github.com/sesquicadaver/MTDirector/issues/404) | Controller Kestrel mTLS client certificates | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…02 — **DONE**; **NEXT = W7-03** |
...
| §3.C Continuous | 1 | W7-02 **DONE**; W7-03 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-03 (#404)** |
...
| Controller mTLS client certs | W7-03 | Kestrel ClientCertificateMode + Desktop cert | **OPEN** (#404) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-03 (#404)**. W7-02 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-03 (#404)**. W7-02 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
