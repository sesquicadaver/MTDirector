...
**Базовий коміт аудиту:** `main` @ post-W7-01 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; **§3.C NEXT = W7-02 (#402)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 30 | 1 | CONT…SEC-15 + W7-01 **DONE**; **NEXT = W7-02** |
| **Разом (код)** | **155** | **0** | SEC-14 closed in Application |
| **Разом (черга §3)** | **159** | **1** | **NEXT = W7-02 (#402)** |
...
**Статус:** **§3.C NEXT = W7-02 (#402).** W7-01 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 164 | W7-02 | [#402](https://github.com/sesquicadaver/MTDirector/issues/402) | Bind gRPC actor to authenticated principal | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01 — **DONE**; **NEXT = W7-02** |
...
| §3.C Continuous | 1 | W7-01 **DONE**; W7-02 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-02 (#402)** |
...
| gRPC actor ↔ principal | W7-02 | Bind actor to authenticated principal | **OPEN** (#402) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-02 (#402)**. W7-01 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-02 (#402)**. W7-01 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
