...
**Базовий коміт аудиту:** `main` @ post-W7-42 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…42 DONE; **§3.C NEXT = W7-43 (#484)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 71 | 1 | CONT…SEC-15 + W7-01…42 **DONE**; **NEXT = W7-43** |
| **Разом (код)** | **196** | **0** | W7-42 continuous residual seed after WriteEnabled |
| **Разом (черга §3)** | **200** | **1** | **NEXT = W7-43 (#484)** |
...
**Статус:** **§3.C NEXT = W7-43 (#484).** W7-42 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 205 | W7-43 | [#484](https://github.com/sesquicadaver/MTDirector/issues/484) | Lock N1-07 path-class E2E DONE residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…42 — **DONE**; **NEXT = W7-43** |
...
| §3.C Continuous | 1 | W7-42 **DONE**; W7-43 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-43 (#484)** |
...
| N1-07 path-class E2E DONE residual Living Spec | W7-43 | Lock known-limitations residual | **OPEN** (#484) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-43 (#484)**. W7-42 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-43 (#484)**. W7-42 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
