...
**Дата оновлення:** 5 вересня 2026 (W7-28 Golden live CHR hashes env-gated residual)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-28 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…28 DONE; **§3.C NEXT = W7-29 (#457)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 57 | 1 | CONT…SEC-15 + W7-01…28 **DONE**; **NEXT = W7-29** |
| **Разом (код)** | **182** | **0** | W7-28 Golden live CHR hashes env-gated residual |
| **Разом (черга §3)** | **186** | **1** | **NEXT = W7-29 (#457)** |
...
**Статус:** **§3.C NEXT = W7-29 (#457).** W7-28 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 191 | W7-29 | [#457](https://github.com/sesquicadaver/MTDirector/issues/457) | Lock Live physical CRS hardware OFF ops residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…28 — **DONE**; **NEXT = W7-29** |
...
| §3.C Continuous | 1 | W7-28 **DONE**; W7-29 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-29 (#457)** |
...
| Live physical CRS hardware OFF ops residual Living Spec | W7-29 | Lock known-limitations residual | **OPEN** (#457) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-29 (#457)**. W7-28 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-29 (#457)**. W7-28 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
