...
**Дата оновлення:** 5 вересня 2026 (W7-33 continuous residual seed after CI billing)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-33 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…33 DONE; **§3.C NEXT = W7-34 (#466)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 62 | 1 | CONT…SEC-15 + W7-01…33 **DONE**; **NEXT = W7-34** |
| **Разом (код)** | **187** | **0** | W7-33 continuous residual seed after CI billing |
| **Разом (черга §3)** | **191** | **1** | **NEXT = W7-34 (#466)** |
...
**Статус:** **§3.C NEXT = W7-34 (#466).** W7-33 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 196 | W7-34 | [#466](https://github.com/sesquicadaver/MTDirector/issues/466) | Lock Desktop window does not stop Controller residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…33 — **DONE**; **NEXT = W7-34** |
...
| §3.C Continuous | 1 | W7-33 **DONE**; W7-34 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-34 (#466)** |
...
| Desktop window does not stop Controller residual Living Spec | W7-34 | Lock known-limitations residual | **OPEN** (#466) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-34 (#466)**. W7-33 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-34 (#466)**. W7-33 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
