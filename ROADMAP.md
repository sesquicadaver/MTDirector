...
**Базовий коміт аудиту:** `main` @ post-W7-43 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…43 DONE; **§3.C NEXT = W7-44 (#486)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 72 | 1 | CONT…SEC-15 + W7-01…43 **DONE**; **NEXT = W7-44** |
| **Разом (код)** | **196** | **0** | W7-42 continuous residual seed after WriteEnabled |
| **Разом (черга §3)** | **201** | **1** | **NEXT = W7-44 (#486)** |
...
**Статус:** **§3.C NEXT = W7-44 (#486).** W7-43 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 206 | W7-44 | [#486](https://github.com/sesquicadaver/MTDirector/issues/486) | Seed next continuous residual after N1-07 Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…43 — **DONE**; **NEXT = W7-44** |
...
| §3.C Continuous | 1 | W7-43 **DONE**; W7-44 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-44 (#486)** |
...
| Seed next continuous residual after N1-07 Living Spec | W7-44 | Seed §3.C next residual tranche | **OPEN** (#486) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-44 (#486)**. W7-43 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-44 (#486)**. W7-43 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
