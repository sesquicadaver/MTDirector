...
**Дата оновлення:** 5 вересня 2026 (W7-04 mTLS TrustedCa validation)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-04 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…04 DONE; **§3.C NEXT = W7-05 (#409)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 33 | 1 | CONT…SEC-15 + W7-01…04 **DONE**; **NEXT = W7-05** |
| **Разом (код)** | **158** | **0** | W7-04 mTLS TrustedCa validation |
| **Разом (черга §3)** | **162** | **1** | **NEXT = W7-05 (#409)** |
...
**Статус:** **§3.C NEXT = W7-05 (#409).** W7-04 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 167 | W7-05 | [#409](https://github.com/sesquicadaver/MTDirector/issues/409) | Bind Desktop actor from client cert CN | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…04 — **DONE**; **NEXT = W7-05** |
...
| §3.C Continuous | 1 | W7-04 **DONE**; W7-05 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-05 (#409)** |
...
| Desktop actor from client cert CN | W7-05 | Align Desktop actor with mTLS identity | **OPEN** (#409) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-05 (#409)**. W7-04 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-05 (#409)**. W7-04 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
