...
**Дата оновлення:** 6 вересня 2026 (W7-37 gRPC remains available for automation residual)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-37 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…37 DONE; **§3.C NEXT = W7-38 (#474)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 66 | 1 | CONT…SEC-15 + W7-01…37 **DONE**; **NEXT = W7-38** |
| **Разом (код)** | **191** | **0** | W7-37 gRPC remains available for automation residual |
| **Разом (черга §3)** | **195** | **1** | **NEXT = W7-38 (#474)** |
...
**Статус:** **§3.C NEXT = W7-38 (#474).** W7-37 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 200 | W7-38 | [#474](https://github.com/sesquicadaver/MTDirector/issues/474) | Seed next continuous residual after gRPC automation Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…37 — **DONE**; **NEXT = W7-38** |
...
| §3.C Continuous | 1 | W7-37 **DONE**; W7-38 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-38 (#474)** |
...
| Seed next continuous residual after gRPC automation Living Spec | W7-38 | Seed §3.C next residual tranche | **OPEN** (#474) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-38 (#474)**. W7-37 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-38 (#474)**. W7-37 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
