...
**Дата оновлення:** 3 вересня 2026 (SEC-11 drift detect + response-feedback UoW)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-SEC-11 — M7.4 CLOSED; W6-01…W6-09 DONE; SEC-01…11 DONE; **§3.C NEXT = SEC-12 (#392)**
...
| §3.C Continuous (glue + W5 + W6 + SEC) | 25 | 1 | CONT…W6-09 + SEC-01…11 **DONE**; **NEXT = SEC-12** |
| **Разом (код)** | **152** | **0** | SEC-11 closed in Application |
| **Разом (черга §3)** | **154** | **1** | **NEXT = SEC-12 (#392)** |
...
**Статус:** **§3.C NEXT = SEC-12 (#392).** SEC-01…11 **DONE**. W6-01…W6-09 **DONE**. Physical CRS runner remains ops residual.  
...
| 159 | SEC-12 | [#392](https://github.com/sesquicadaver/MTDirector/issues/392) | CaptureSnapshot persist+audit UoW | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT-01…02 + W5 + W6 + SEC-01…11 — **DONE**; **NEXT = SEC-12** |
...
| §3.C Continuous | 1 | SEC-01…11 **DONE**; SEC-12 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = SEC-12 (#392)** |
...
| CaptureSnapshot persist+audit UoW | SEC-12 | `CaptureSnapshotUseCase` persist+audit UoW | **OPEN** (#392) |
...
Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = SEC-12 (#392)**. SEC-11 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = SEC-12 (#392)**. SEC-11 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
