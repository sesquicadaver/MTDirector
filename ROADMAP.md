...
**Дата оновлення:** 5 вересня 2026 (W7-07 prefer HttpContext.User)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-07 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…07 DONE; **§3.C NEXT = W7-08 (#415)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 36 | 1 | CONT…SEC-15 + W7-01…07 **DONE**; **NEXT = W7-08** |
| **Разом (код)** | **161** | **0** | W7-07 prefer HttpContext.User |
| **Разом (черга §3)** | **165** | **1** | **NEXT = W7-08 (#415)** |
...
**Статус:** **§3.C NEXT = W7-08 (#415).** W7-07 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 170 | W7-08 | [#415](https://github.com/sesquicadaver/MTDirector/issues/415) | Desktop status shows resolved mTLS actor | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…07 — **DONE**; **NEXT = W7-08** |
...
| §3.C Continuous | 1 | W7-07 **DONE**; W7-08 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-08 (#415)** |
...
| Desktop status resolved mTLS actor | W7-08 | Connection status shows actor | **OPEN** (#415) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-08 (#415)**. W7-07 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-08 (#415)**. W7-07 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
