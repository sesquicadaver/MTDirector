...
**Базовий коміт аудиту:** `main` @ post-W7-96 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…96 DONE; PLAN-05 COMPLETE; PLAN-06 COMPLETE; **§3.C NEXT = W7-97 (#593)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 95 | 1 | CONT…SEC-15 + W7-01…96 **DONE**; PLAN-05 COMPLETE; PLAN-06 COMPLETE; PLAN-08 COMPLETE; **NEXT = W7-97** |
| **Разом (код)** | **196** | **0** | W7-42 continuous residual seed after WriteEnabled |
| **Разом (черга §3)** | **224** | **1** | **NEXT = W7-97 (#574)** |
...
**Статус:** **§3.C NEXT = W7-97 (#593).** W7-96 **DONE**; PLAN-08 **COMPLETE**; PLAN-07 **COMPLETE**; PLAN-05 **COMPLETE**; PLAN-06 **COMPLETE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 259 | W7-97 | [#593](https://github.com/sesquicadaver/MTDirector/issues/593) | Seed next product tranche after PLAN-08 → PLAN-09 | **OPEN** |
| 260 | W7-98 | [#594](https://github.com/sesquicadaver/MTDirector/issues/594) | PLAN-09 — Inventory next Desktop connection-status operator-surface Living Spec product tranche | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…96 + PLAN-05 + PLAN-06 + PLAN-07 + PLAN-08 — **DONE**; **NEXT = W7-97** |
...
| §3.C Continuous | 1 | W7-96 **DONE**; PLAN-08 **COMPLETE**; PLAN-07 **COMPLETE**; PLAN-05 **COMPLETE**; PLAN-06 **COMPLETE**; W7-97 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-97 (#593)** |
...
Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-97 (#593)**. W7-96 **DONE**; PLAN-08 **COMPLETE**; PLAN-07 **COMPLETE**; PLAN-05 **COMPLETE**; PLAN-06 **COMPLETE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-97 (#593)**. W7-96 **DONE**; PLAN-08 **COMPLETE**; PLAN-07 **COMPLETE**; PLAN-05 **COMPLETE**; PLAN-06 **COMPLETE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
