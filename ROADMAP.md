...
**Дата оновлення:** 5 вересня 2026 (W7-10 mTLS principal redacted log)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-10 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…10 DONE; **§3.C NEXT = W7-11 (#421)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 39 | 1 | CONT…SEC-15 + W7-01…10 **DONE**; **NEXT = W7-11** |
| **Разом (код)** | **164** | **0** | W7-10 mTLS principal redacted log |
| **Разом (черга §3)** | **168** | **1** | **NEXT = W7-11 (#421)** |
...
**Статус:** **§3.C NEXT = W7-11 (#421).** W7-10 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 173 | W7-11 | [#421](https://github.com/sesquicadaver/MTDirector/issues/421) | Harden SessionFaultInjection timeout pending-clear assertion | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…10 — **DONE**; **NEXT = W7-11** |
...
| §3.C Continuous | 1 | W7-10 **DONE**; W7-11 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-11 (#421)** |
...
| SessionFaultInjection timeout pending clear | W7-11 | Deterministic pending wait | **OPEN** (#421) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-11 (#421)**. W7-10 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-11 (#421)**. W7-10 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
