...
**Дата оновлення:** 3 вересня 2026 (SEC-04 INTERNAL_CA trusted CA store)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-SEC-04 — M7.4 CLOSED; W6-01…W6-09 DONE; SEC-01…04 DONE; **§3.C NEXT = SEC-05 (#378)**
...
| §3.C Continuous (glue + W5 + W6 + SEC) | 19 | 1 | CONT…W6-09 + SEC-01…04 **DONE**; **NEXT = SEC-05** |
| **Разом (код)** | **145** | **1** | SEC-05 OPEN |
| **Разом (черга §3)** | **148** | **1** | **NEXT = SEC-05 (#378)** |
...
**Статус:** **§3.C NEXT = SEC-05 (#378).** SEC-01…04 **DONE**. W6-01…W6-09 **DONE**. Physical CRS runner remains ops residual.  
...
| 152 | SEC-05 | [#378](https://github.com/sesquicadaver/MTDirector/issues/378) | Atomic mutation + idempotency + audit boundary | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT-01…02 + W5 + W6 + SEC-01…04 — **DONE**; **NEXT = SEC-05** |
...
| §3.C Continuous | 1 | SEC-05 **OPEN**; SEC-01…04 **DONE**; CRS lab ops residual |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = SEC-05 (#378)** |
...
Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = SEC-05 (#378)**. SEC-03 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = SEC-05 (#378)**. SEC-03 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
