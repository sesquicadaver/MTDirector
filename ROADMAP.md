...
**Дата оновлення:** 6 вересня 2026 (W7-40 continuous residual seed after RouterOs fail-closed)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-40 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…40 DONE; **§3.C NEXT = W7-41 (#480)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 69 | 1 | CONT…SEC-15 + W7-01…40 **DONE**; **NEXT = W7-41** |
| **Разом (код)** | **194** | **0** | W7-40 continuous residual seed after RouterOs fail-closed |
| **Разом (черга §3)** | **198** | **1** | **NEXT = W7-41 (#480)** |
...
**Статус:** **§3.C NEXT = W7-41 (#480).** W7-40 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 203 | W7-41 | [#480](https://github.com/sesquicadaver/MTDirector/issues/480) | Lock RouterOs WriteEnabled operator residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…40 — **DONE**; **NEXT = W7-41** |
...
| §3.C Continuous | 1 | W7-40 **DONE**; W7-41 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-41 (#480)** |
...
| RouterOs WriteEnabled operator residual Living Spec | W7-41 | Lock known-limitations residual | **OPEN** (#480) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-41 (#480)**. W7-40 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-41 (#480)**. W7-40 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
