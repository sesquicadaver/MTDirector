...
**Базовий коміт аудиту:** M7.2-04 — CHR/fixture acceptance for endpoint migration DONE; **M7.2 CLOSED**; NEXT = M7.3-01 (#125)
...
M7.1-03 DONE. M7.1-04 DONE. M7.1-05 DONE. M7.1-06 DONE. M7.1-07 DONE. M7.1-08 DONE. M7.1-09 DONE. M7.1-10 DONE. **M7.1-11 DONE. M7.1 CLOSED.** **M7.2-01 DONE.** **M7.2-02 DONE.** **M7.2-03 DONE.** **M7.2-04 DONE. M7.2 CLOSED.** Post-MVP M7 = **12** open (NEXT = M7.3-01 #125).
...
**NEXT = M7.3-01:** [M7.3-01](https://github.com/sesquicadaver/MTDirector/issues/125) Define IncidentSignal ingress contract. **M7.2 CLOSED.**
...
**Кінець черги:** 12 відкритих атомарних задач (усі Post-MVP M7). Start here: #125 M7.3-01.
...
| Post-MVP M7 | 12 | NEXT = M7.3-01 (#125) |
| **Нереалізовано разом** | **16** | лише M7 |
...
54. Відкрити **M7.3-01** → [issue #125](https://github.com/sesquicadaver/MTDirector/issues/125).
