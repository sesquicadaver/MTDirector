...
**Дата оновлення:** 5 вересня 2026 (W7-30 Controller migrate-only startup residual)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-30 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…30 DONE; **§3.C NEXT = W7-31 (#460)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 59 | 1 | CONT…SEC-15 + W7-01…30 **DONE**; **NEXT = W7-31** |
| **Разом (код)** | **184** | **0** | W7-30 Controller migrate-only startup residual |
| **Разом (черга §3)** | **188** | **1** | **NEXT = W7-31 (#460)** |
...
**Статус:** **§3.C NEXT = W7-31 (#460).** W7-30 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 193 | W7-31 | [#460](https://github.com/sesquicadaver/MTDirector/issues/460) | Lock Development master-key provider residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…30 — **DONE**; **NEXT = W7-31** |
...
| §3.C Continuous | 1 | W7-30 **DONE**; W7-31 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-31 (#460)** |
...
| Development master-key provider residual Living Spec | W7-31 | Lock known-limitations residual | **OPEN** (#460) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-31 (#460)**. W7-30 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-31 (#460)**. W7-30 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
