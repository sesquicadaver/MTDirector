...
**Дата оновлення:** 26 серпня 2026 (P2-08 DONE; **NEXT = P2-09**)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `v0.2.0` — M7.4 CLOSED; P2 read path CLOSED; **NEXT = P2-09** (#295)
...
**Кінець черги §3 (наразі):** **NEXT = P2-09** (#295). Лінійний ланцюжок: P2-09 → P2-10 → P2-11.
...
| P2 Pilot (write path) | 3 | **NEXT = P2-09** (#295) |
| **Нереалізовано (§3)** | **3** | P2-09…P2-11 |
