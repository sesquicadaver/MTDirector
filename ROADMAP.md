...
| `Mfc.Domain.Endpoint` | `EndpointAttributionResolver` + snapshot facts + hop chain + certainty (M7.2-01) + `EndpointPresenceInterval` / `EndpointRoutingContext` + builders + migration open/close (M7.2-02) |
