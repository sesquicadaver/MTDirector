...
**Дата оновлення:** 5 вересня 2026 (W7-15 pilot-runbook TraceIdentifier)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-15 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…15 DONE; **§3.C NEXT = W7-16 (#431)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 44 | 1 | CONT…SEC-15 + W7-01…15 **DONE**; **NEXT = W7-16** |
| **Разом (код)** | **169** | **0** | W7-15 pilot-runbook TraceIdentifier |
| **Разом (черга §3)** | **173** | **1** | **NEXT = W7-16 (#431)** |
...
**Статус:** **§3.C NEXT = W7-16 (#431).** W7-15 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 178 | W7-16 | [#431](https://github.com/sesquicadaver/MTDirector/issues/431) | controller-configuration.md TraceIdentifier cross-link | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…15 — **DONE**; **NEXT = W7-16** |
...
| §3.C Continuous | 1 | W7-15 **DONE**; W7-16 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-16 (#431)** |
...
| controller-configuration TraceIdentifier cross-link | W7-16 | Ops config doc correlation | **OPEN** (#431) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-16 (#431)**. W7-15 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-16 (#431)**. W7-15 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
