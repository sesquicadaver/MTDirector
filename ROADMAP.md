...
**Дата оновлення:** 5 вересня 2026 (W7-09 Production mTLS checklist)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-09 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…09 DONE; **§3.C NEXT = W7-10 (#419)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 38 | 1 | CONT…SEC-15 + W7-01…09 **DONE**; **NEXT = W7-10** |
| **Разом (код)** | **163** | **0** | W7-09 Production mTLS checklist |
| **Разом (черга §3)** | **167** | **1** | **NEXT = W7-10 (#419)** |
...
**Статус:** **§3.C NEXT = W7-10 (#419).** W7-09 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 172 | W7-10 | [#419](https://github.com/sesquicadaver/MTDirector/issues/419) | Log redacted client-cert thumbprint on mTLS principal map | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…09 — **DONE**; **NEXT = W7-10** |
...
| §3.C Continuous | 1 | W7-09 **DONE**; W7-10 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-10 (#419)** |
...
| mTLS principal map log (redacted) | W7-10 | CN + thumbprint prefix log | **OPEN** (#419) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-10 (#419)**. W7-08 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-10 (#419)**. W7-08 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
