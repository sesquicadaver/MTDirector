...
**Дата оновлення:** 5 вересня 2026 (W7-16 controller-configuration TraceIdentifier)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-16 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…16 DONE; **§3.C NEXT = W7-17 (#433)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 45 | 1 | CONT…SEC-15 + W7-01…16 **DONE**; **NEXT = W7-17** |
| **Разом (код)** | **170** | **0** | W7-16 controller-configuration TraceIdentifier |
| **Разом (черга §3)** | **174** | **1** | **NEXT = W7-17 (#433)** |
...
**Статус:** **§3.C NEXT = W7-17 (#433).** W7-16 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 179 | W7-17 | [#433](https://github.com/sesquicadaver/MTDirector/issues/433) | Lock resolve-only zone UoW residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…16 — **DONE**; **NEXT = W7-17** |
...
| §3.C Continuous | 1 | W7-16 **DONE**; W7-17 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-17 (#433)** |
...
| Resolve-only zone UoW residual Living Spec | W7-17 | Lock known-limitations residual | **OPEN** (#433) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-17 (#433)**. W7-16 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-17 (#433)**. W7-16 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
