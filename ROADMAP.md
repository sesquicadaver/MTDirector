...
**Базовий коміт аудиту:** M7.1-07 — reverse-path symmetry analysis DONE; **MVP CLOSED**; черга зсунута на M7.1-08 (#117)
...
**NEXT = M7.1-08:** [M7.1-08](https://github.com/sesquicadaver/MTDirector/issues/117) Bind NetworkPathProfile latency probes to routing result. **M7.1-07 DONE.**
...
**Кінець черги:** 20 відкритих атомарних задач (усі Post-MVP M7). Start here: #117 M7.1-08.
...
| Post-MVP M7 | 20 | NEXT = M7.1-08 (#117) |
...
52. Відкрити **M7.1-08** → [issue #117](https://github.com/sesquicadaver/MTDirector/issues/117).
