...
**Дата оновлення:** 5 вересня 2026 (W7-34 Desktop window does not stop Controller residual)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-34 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…34 DONE; **§3.C NEXT = W7-35 (#468)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 63 | 1 | CONT…SEC-15 + W7-01…34 **DONE**; **NEXT = W7-35** |
| **Разом (код)** | **188** | **0** | W7-34 Desktop window does not stop Controller residual |
| **Разом (черга §3)** | **192** | **1** | **NEXT = W7-35 (#468)** |
...
**Статус:** **§3.C NEXT = W7-35 (#468).** W7-34 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 197 | W7-35 | [#468](https://github.com/sesquicadaver/MTDirector/issues/468) | Lock Inventory Add router wizard DONE residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…34 — **DONE**; **NEXT = W7-35** |
...
| §3.C Continuous | 1 | W7-34 **DONE**; W7-35 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-35 (#468)** |
...
| Inventory Add router wizard DONE residual Living Spec | W7-35 | Lock known-limitations residual | **OPEN** (#468) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-35 (#468)**. W7-34 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-35 (#468)**. W7-34 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
