...
**Базовий коміт аудиту:** M1-21 (canonicalization primitives) — черга зсунута на M1-22
...
| M1 Read-only slice | 21 | 13 | 62% |
| N1 Packet-path weave | 3 | 4 | 43% |
| M2–M6 (решта MVP) | 0 | 58 | 0% |
| M7 Post-MVP | 0 | 27 | 0% |
| **Разом** | **34** | **102** | **~25% issues** |

MVP issues (109) = 34 done + **75 remaining** до MVP CLOSED.  
...
| Збірка | Стан |
|--------|------|
| `Mfc.RouterOs` | protocol + discovery + capability + N1 + stable-read + raw snapshot; next: menu canonical snapshots (M1-22) |
...
**NEXT = черга #21:** [M1-22](https://github.com/sesquicadaver/MTDirector/issues/32).
...
| Menu canonical + persist + diff | M1-22…24 | section maps; vectors; diff unit | TODO #21 |
...
1. Відкрити **чергу #21** → [M1-22 / issue #32](https://github.com/sesquicadaver/MTDirector/issues/32).  
