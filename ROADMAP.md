...
**Базовий коміт аудиту:** `main` @ post-W6-05 — M7.4 CLOSED; P2 read + write CLOSED; Desktop alignment W1–W4 / W2.1–W2.2 DONE; CONT-01…02 DONE; W5-01…03 DONE; W6-01…W6-05 DONE; **§3.C NEXT = residual (CRS lab ops)**
...
| **§3.C Continuous** | PLAN-02 + CONT-01…02 + W5-01…03 + W6-01…05 — **CLOSED**; residual CRS lab ops |
...
| §3.C Continuous | 0 | W5-01…03 + W6-01…W6-05 **DONE**; residual CRS lab ops |
...
Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = residual (CRS lab ops)**. W6-05 **DONE**. CRS/physical lab runner stays ops, not a §3 product row.
...
1. **§3.C NEXT = residual (CRS lab ops)**. W6-05 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops, не продуктний рядок.
