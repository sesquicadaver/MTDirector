...
**Дата оновлення:** 5 вересня 2026 (W7-20 Feedback delivery / RouterOS capture outside-DB residual)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-20 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…20 DONE; **§3.C NEXT = W7-21 (#441)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 49 | 1 | CONT…SEC-15 + W7-01…20 **DONE**; **NEXT = W7-21** |
| **Разом (код)** | **174** | **0** | W7-20 Feedback delivery / RouterOS capture outside-DB residual |
| **Разом (черга §3)** | **178** | **1** | **NEXT = W7-21 (#441)** |
...
**Статус:** **§3.C NEXT = W7-21 (#441).** W7-20 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 183 | W7-21 | [#441](https://github.com/sesquicadaver/MTDirector/issues/441) | Lock IResponseFeedbackDeliveryPort not-configured residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…20 — **DONE**; **NEXT = W7-21** |
...
| §3.C Continuous | 1 | W7-20 **DONE**; W7-21 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-21 (#441)** |
...
| IResponseFeedbackDeliveryPort not-configured residual Living Spec | W7-21 | Lock known-limitations residual | **OPEN** (#441) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-21 (#441)**. W7-20 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-21 (#441)**. W7-20 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
