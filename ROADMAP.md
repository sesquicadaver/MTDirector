...
**Дата оновлення:** 5 вересня 2026 (W7-26 MVP scope-lock no-campaigns/auto-deploy residual)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-26 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…26 DONE; **§3.C NEXT = W7-27 (#453)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 55 | 1 | CONT…SEC-15 + W7-01…26 **DONE**; **NEXT = W7-27** |
| **Разом (код)** | **180** | **0** | W7-26 MVP scope-lock no-campaigns/auto-deploy residual |
| **Разом (черга §3)** | **184** | **1** | **NEXT = W7-27 (#453)** |
...
**Статус:** **§3.C NEXT = W7-27 (#453).** W7-26 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 189 | W7-27 | [#453](https://github.com/sesquicadaver/MTDirector/issues/453) | Lock Live CHR matrix OFF residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…26 — **DONE**; **NEXT = W7-27** |
...
| §3.C Continuous | 1 | W7-26 **DONE**; W7-27 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-27 (#453)** |
...
| Live CHR matrix OFF residual Living Spec | W7-27 | Lock known-limitations residual | **OPEN** (#453) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-27 (#453)**. W7-26 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-27 (#453)**. W7-26 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
