...
**Дата оновлення:** 5 вересня 2026 (W7-29 Live physical CRS hardware OFF ops residual)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-29 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…29 DONE; **§3.C NEXT = W7-30 (#459)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 58 | 1 | CONT…SEC-15 + W7-01…29 **DONE**; **NEXT = W7-30** |
| **Разом (код)** | **183** | **0** | W7-29 Live physical CRS hardware OFF ops residual |
| **Разом (черга §3)** | **187** | **1** | **NEXT = W7-30 (#459)** |
...
**Статус:** **§3.C NEXT = W7-30 (#459).** W7-29 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 192 | W7-30 | [#459](https://github.com/sesquicadaver/MTDirector/issues/459) | Lock Controller migrate-only startup residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…29 — **DONE**; **NEXT = W7-30** |
...
| §3.C Continuous | 1 | W7-29 **DONE**; W7-30 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-30 (#459)** |
...
| Controller migrate-only startup residual Living Spec | W7-30 | Lock known-limitations residual | **OPEN** (#459) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-30 (#459)**. W7-29 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-30 (#459)**. W7-29 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
