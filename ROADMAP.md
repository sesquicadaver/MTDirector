...
**Дата оновлення:** 5 вересня 2026 (W7-18 Start* AddOperationAsync outside-UoW residual)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-18 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…18 DONE; **§3.C NEXT = W7-19 (#437)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 47 | 1 | CONT…SEC-15 + W7-01…18 **DONE**; **NEXT = W7-19** |
| **Разом (код)** | **172** | **0** | W7-18 Start* AddOperationAsync outside-UoW residual |
| **Разом (черга §3)** | **176** | **1** | **NEXT = W7-19 (#437)** |
...
**Статус:** **§3.C NEXT = W7-19 (#437).** W7-18 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 181 | W7-19 | [#437](https://github.com/sesquicadaver/MTDirector/issues/437) | Lock orchestrator-only audit residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…18 — **DONE**; **NEXT = W7-19** |
...
| §3.C Continuous | 1 | W7-18 **DONE**; W7-19 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-19 (#437)** |
...
| Orchestrator-only audit residual Living Spec | W7-19 | Lock known-limitations residual | **OPEN** (#437) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-19 (#437)**. W7-18 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-19 (#437)**. W7-18 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
