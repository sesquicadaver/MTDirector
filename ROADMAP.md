...
**Базовий коміт аудиту:** M7.2-01 — endpoint attribution resolver DONE; NEXT = M7.2-02 (#122)
...
M7.1-03 DONE. M7.1-04 DONE. M7.1-05 DONE. M7.1-06 DONE. M7.1-07 DONE. M7.1-08 DONE. M7.1-09 DONE. M7.1-10 DONE. **M7.1-11 DONE. M7.1 CLOSED.** **M7.2-01 DONE.** Post-MVP M7 = **15** open (NEXT = M7.2-02 #122).
...
| `Mfc.Domain.Endpoint` | `EndpointAttributionResolver` + snapshot facts + hop chain + certainty (M7.2-01) |
...
**NEXT = M7.2-02:** [M7.2-02](https://github.com/sesquicadaver/MTDirector/issues/122) EndpointPresenceInterval and EndpointRoutingContext. **M7.2-01 DONE.**
...
**Кінець черги:** 15 відкритих атомарних задач (усі Post-MVP M7). Start here: #122 M7.2-02.
...
| Post-MVP M7 | 15 | NEXT = M7.2-02 (#122) |
...
52. Відкрити **M7.2-02** → [issue #122](https://github.com/sesquicadaver/MTDirector/issues/122).
