...
**Дата оновлення:** 5 вересня 2026 (W7-23 SHA256SUMS attestation packaging residual)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-23 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…23 DONE; **§3.C NEXT = W7-24 (#447)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 52 | 1 | CONT…SEC-15 + W7-01…23 **DONE**; **NEXT = W7-24** |
| **Разом (код)** | **177** | **0** | W7-23 SHA256SUMS attestation packaging residual |
| **Разом (черга §3)** | **181** | **1** | **NEXT = W7-24 (#447)** |
...
**Статус:** **§3.C NEXT = W7-24 (#447).** W7-23 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 186 | W7-24 | [#447](https://github.com/sesquicadaver/MTDirector/issues/447) | Lock CycloneDX-lite SBOM packaging residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…23 — **DONE**; **NEXT = W7-24** |
...
| §3.C Continuous | 1 | W7-23 **DONE**; W7-24 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-24 (#447)** |
...
| CycloneDX-lite SBOM packaging residual Living Spec | W7-24 | Lock known-limitations residual | **OPEN** (#447) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-24 (#447)**. W7-23 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-24 (#447)**. W7-23 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
