...
**Базовий коміт аудиту:** `main` @ post-W7-60 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…60 DONE; **§3.C NEXT = W7-61 (#520)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 89 | 1 | CONT…SEC-15 + W7-01…60 **DONE**; **NEXT = W7-61** |
| **Разом (код)** | **196** | **0** | W7-42 continuous residual seed after WriteEnabled |
| **Разом (черга §3)** | **218** | **1** | **NEXT = W7-61 (#520)** |
...
**Статус:** **§3.C NEXT = W7-61 (#520).** W7-60 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 223 | W7-61 | [#520](https://github.com/sesquicadaver/MTDirector/issues/520) | CT-DRIFT-01 — DriftService GrpcHost contract Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…60 — **DONE**; **NEXT = W7-61** |
...
| §3.C Continuous | 1 | W7-60 **DONE**; W7-61 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-61 (#520)** |
...
| CT-DRIFT-01 — DriftService GrpcHost contract Living Spec | W7-61 | Contract-test Living Spec | **OPEN** (#520) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-61 (#520)**. W7-60 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-61 (#520)**. W7-60 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
