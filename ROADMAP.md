...
**Дата оновлення:** 5 вересня 2026 (W7-25 MVP scope-lock no-NAT/RAW writes residual)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-25 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…25 DONE; **§3.C NEXT = W7-26 (#451)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 54 | 1 | CONT…SEC-15 + W7-01…25 **DONE**; **NEXT = W7-26** |
| **Разом (код)** | **179** | **0** | W7-25 MVP scope-lock no-NAT/RAW writes residual |
| **Разом (черга §3)** | **183** | **1** | **NEXT = W7-26 (#451)** |
...
**Статус:** **§3.C NEXT = W7-26 (#451).** W7-25 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 188 | W7-26 | [#451](https://github.com/sesquicadaver/MTDirector/issues/451) | Lock MVP scope-lock no-campaigns/auto-deploy residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…25 — **DONE**; **NEXT = W7-26** |
...
| §3.C Continuous | 1 | W7-25 **DONE**; W7-26 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-26 (#451)** |
...
| MVP scope-lock no-campaigns/auto-deploy residual Living Spec | W7-26 | Lock known-limitations residual | **OPEN** (#451) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-26 (#451)**. W7-25 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-26 (#451)**. W7-25 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
