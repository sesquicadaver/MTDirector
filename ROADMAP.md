...
**Дата оновлення:** 3 вересня 2026 (SEC-03 audit hash chain)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-SEC-03 — M7.4 CLOSED; W6-01…W6-09 DONE; SEC-01…03 DONE; **§3.C NEXT = residual (CRS lab ops)**
...
| §3.C Continuous (glue + W5 + W6 + SEC) | 17 | 0 | CONT…W6-09 + SEC-01…03 **DONE**; **NEXT = residual** |
| **Разом (код)** | **144** | **0** | SEC tranche closed |
| **Разом (черга §3)** | **146** | **0** | **NEXT = residual (CRS lab ops)** |
...
**Статус:** **§3.C residual (CRS lab ops).** SEC-01…03 **DONE**. W6-01…W6-09 **DONE**. Physical CRS runner remains ops residual.  
...
Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = residual (CRS lab ops)**. SEC-03 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = residual (CRS lab ops)**. SEC-03 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
