...
**Базовий коміт аудиту:** `main` @ post-W7-45 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…45 DONE; **§3.C NEXT = W7-46 (#490)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 74 | 1 | CONT…SEC-15 + W7-01…45 **DONE**; **NEXT = W7-46** |
| **Разом (код)** | **196** | **0** | W7-42 continuous residual seed after WriteEnabled |
| **Разом (черга §3)** | **203** | **1** | **NEXT = W7-46 (#490)** |
...
**Статус:** **§3.C NEXT = W7-46 (#490).** W7-45 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 208 | W7-46 | [#490](https://github.com/sesquicadaver/MTDirector/issues/490) | Seed next continuous residual after M7 CLOSED Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…45 — **DONE**; **NEXT = W7-46** |
...
| §3.C Continuous | 1 | W7-45 **DONE**; W7-46 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-46 (#490)** |
...
| Seed next continuous residual after M7 CLOSED Living Spec | W7-46 | Seed §3.C next residual tranche | **OPEN** (#490) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-46 (#490)**. W7-45 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-46 (#490)**. W7-45 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
