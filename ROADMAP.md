...
**Дата оновлення:** 5 вересня 2026 (W7-13 mTLS map TraceIdentifier)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-13 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…13 DONE; **§3.C NEXT = W7-14 (#427)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 42 | 1 | CONT…SEC-15 + W7-01…13 **DONE**; **NEXT = W7-14** |
| **Разом (код)** | **167** | **0** | W7-13 mTLS map TraceIdentifier |
| **Разом (черга §3)** | **171** | **1** | **NEXT = W7-14 (#427)** |
...
**Статус:** **§3.C NEXT = W7-14 (#427).** W7-13 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 176 | W7-14 | [#427](https://github.com/sesquicadaver/MTDirector/issues/427) | SECURITY.md documents TraceIdentifier on mTLS map log | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…13 — **DONE**; **NEXT = W7-14** |
...
| §3.C Continuous | 1 | W7-13 **DONE**; W7-14 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-14 (#427)** |
...
| SECURITY.md TraceIdentifier on mTLS map log | W7-14 | Document correlation field | **OPEN** (#427) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-14 (#427)**. W7-13 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-14 (#427)**. W7-13 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
