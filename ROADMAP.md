...
**Дата оновлення:** 5 вересня 2026 (W7-22 Desktop zip/tar installer packaging residual)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-22 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…22 DONE; **§3.C NEXT = W7-23 (#445)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 51 | 1 | CONT…SEC-15 + W7-01…22 **DONE**; **NEXT = W7-23** |
| **Разом (код)** | **176** | **0** | W7-22 Desktop zip/tar installer packaging residual |
| **Разом (черга §3)** | **180** | **1** | **NEXT = W7-23 (#445)** |
...
**Статус:** **§3.C NEXT = W7-23 (#445).** W7-22 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 185 | W7-23 | [#445](https://github.com/sesquicadaver/MTDirector/issues/445) | Lock SHA256SUMS attestation packaging residual Living Spec | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…22 — **DONE**; **NEXT = W7-23** |
...
| §3.C Continuous | 1 | W7-22 **DONE**; W7-23 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-23 (#445)** |
...
| SHA256SUMS attestation packaging residual Living Spec | W7-23 | Lock known-limitations residual | **OPEN** (#445) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-23 (#445)**. W7-22 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-23 (#445)**. W7-22 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
