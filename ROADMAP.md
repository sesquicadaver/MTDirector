...
**Дата оновлення:** 5 вересня 2026 (W7-11 SessionFaultInjection pending clear)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-11 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…11 DONE; **§3.C NEXT = W7-12 (#423)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 40 | 1 | CONT…SEC-15 + W7-01…11 **DONE**; **NEXT = W7-12** |
| **Разом (код)** | **165** | **0** | W7-11 SessionFaultInjection pending clear |
| **Разом (черга §3)** | **169** | **1** | **NEXT = W7-12 (#423)** |
...
**Статус:** **§3.C NEXT = W7-12 (#423).** W7-11 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 174 | W7-12 | [#423](https://github.com/sesquicadaver/MTDirector/issues/423) | Desktop status Living Spec covers AuthenticationFailed | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…11 — **DONE**; **NEXT = W7-12** |
...
| §3.C Continuous | 1 | W7-11 **DONE**; W7-12 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-12 (#423)** |
...
| Desktop AuthenticationFailed status Living Spec | W7-12 | Non-Connected status without actor | **OPEN** (#423) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-12 (#423)**. W7-11 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-12 (#423)**. W7-11 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
