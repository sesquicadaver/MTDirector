...
**Дата оновлення:** 5 вересня 2026 (W7-06 mTLS → HttpContext.User)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-06 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…06 DONE; **§3.C NEXT = W7-07 (#413)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 35 | 1 | CONT…SEC-15 + W7-01…06 **DONE**; **NEXT = W7-07** |
| **Разом (код)** | **160** | **0** | W7-06 mTLS HttpContext.User |
| **Разом (черга §3)** | **164** | **1** | **NEXT = W7-07 (#413)** |
...
**Статус:** **§3.C NEXT = W7-07 (#413).** W7-06 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 169 | W7-07 | [#413](https://github.com/sesquicadaver/MTDirector/issues/413) | Prefer HttpContext.User over gRPC peer identity for actor | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…06 — **DONE**; **NEXT = W7-07** |
...
| §3.C Continuous | 1 | W7-06 **DONE**; W7-07 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-07 (#413)** |
...
| Prefer User over peer identity | W7-07 | Actor resolver precedence | **OPEN** (#413) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-07 (#413)**. W7-06 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-07 (#413)**. W7-06 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
