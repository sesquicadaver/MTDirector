...
**Базовий коміт аудиту:** M7.1-04 — Model ECMP as ONE_OF bounded next-hop sets DONE; **MVP CLOSED**; черга зсунута на M7.1-05 (#114)
...
| `Mfc.Domain.Routing` | `RoutingAssuranceState` + config/ops snapshots + property classifier + hash contract (M7.1-02) + `RouteResolutionTraceEngine` / policy-routing trace (M7.1-03) + `EcmpRouteSet` ONE_OF bounded next-hop sets (M7.1-04); deferred expectation/finding slots |
...
**NEXT = M7.1-05:** [M7.1-05](https://github.com/sesquicadaver/MTDirector/issues/114) Analyze dynamic route origins (read-only). **M7.1-04 DONE.**
...
**Кінець черги:** 23 відкритих атомарних задач (усі Post-MVP M7). Start here: #114 M7.1-05.
...
| Post-MVP M7 | 23 | NEXT = M7.1-05 (#114) |
...
49. Відкрити **M7.1-05** → [issue #114](https://github.com/sesquicadaver/MTDirector/issues/114).
