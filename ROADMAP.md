...
**Дата оновлення:** 3 вересня 2026 (W7-03 Kestrel mTLS client certs)
**Статус:** нормативний індекс + **лінійна черга** атомарних задач
**Продукт:** MikroTik Firewall Controller (MTDirector)
**Базовий коміт аудиту:** `main` @ post-W7-03 — M7.4 CLOSED; W6 DONE; SEC-01…15 DONE; W7-01…03 DONE; **§3.C NEXT = W7-04 (#406)**
...
| §3.C Continuous (glue + W5 + W6 + SEC + W7) | 32 | 1 | CONT…SEC-15 + W7-01…03 **DONE**; **NEXT = W7-04** |
| **Разом (код)** | **157** | **0** | W7-03 Kestrel client certs |
| **Разом (черга §3)** | **161** | **1** | **NEXT = W7-04 (#406)** |
...
**Статус:** **§3.C NEXT = W7-04 (#406).** W7-03 **DONE**. SEC-01…15 **DONE**. Physical CRS runner remains ops residual.  
...
| 166 | W7-04 | [#406](https://github.com/sesquicadaver/MTDirector/issues/406) | Validate mTLS client certs against TrustedCa | **OPEN** |
...
| **§3.C Continuous** | PLAN-02 + CONT + W5 + W6 + SEC-01…15 + W7-01…03 — **DONE**; **NEXT = W7-04** |
...
| §3.C Continuous | 1 | W7-03 **DONE**; W7-04 **OPEN** |
| **Нереалізовано (§3)** | **1** | **§3.C NEXT = W7-04 (#406)** |
...
| Validate mTLS vs TrustedCa | W7-04 | Client cert chain vs INTERNAL_CA | **OPEN** (#406) |

Оновлювати рядок **Статус** при закритті issue; **§3.C NEXT = W7-04 (#406)**. W7-03 **DONE**. CRS/physical lab runner stays ops residual.
...
1. **§3.C NEXT = W7-04 (#406)**. W7-03 **DONE**. Береться лише відкритий рядок §3; лаба **не** блокує. Physical CRS runner — ops residual.
