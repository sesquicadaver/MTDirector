    ...
    public void Configure(EntityTypeBuilder<DeviceEntity> builder)
    {
        builder.ToTable("devices", table =>
        {
            ...
            table.HasCheckConstraint(
                "ck_devices_last_observed_reachability",
                "\"LastObservedReachability\" IS NULL OR \"LastObservedReachability\" BETWEEN 0 AND 2");
        });
        ...
        builder.Property(e => e.LastObservedReachability);
