...
public sealed class DesktopOptions
{
    ...
    /// <summary>
    /// Actor identity sent as <c>x-mfc-actor</c> when no client certificate is configured.
    /// When <see cref="ClientCertificatePath"/> is set, the certificate CN is used instead (W7-05).
    /// </summary>
