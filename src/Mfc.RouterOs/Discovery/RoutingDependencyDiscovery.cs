...
public static class RoutingDependencyDiscovery
{
        ...
        IReadOnlyList<string>? warnings = null)
    {
        ...
        return new RoutingDependencyDiscoveryResult
        {
            ...
            Ipv4RouteObservations = v4Routes.OrderBy(r => r.DstAddress, StringComparer.Ordinal).ToArray(),
            Ipv6RouteObservations = v6Routes.OrderBy(r => r.DstAddress, StringComparer.Ordinal).ToArray(),
