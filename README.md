...
**Queue (§3.C):** **§3.C NEXT = W7-60 (#518)** — W7-59 ([#516](https://github.com/sesquicadaver/MTDirector/issues/516)) **DONE**. [`docs/planning/continuous-queue-plan.md`](docs/planning/continuous-queue-plan.md). Pilot (parallel): [`docs/operations/pilot-runbook.md`](docs/operations/pilot-runbook.md) (`Enabled` / `WriteEnabled`).  
