...
**Queue (§3.C):** **§3.C NEXT = W7-58 (#514)** — W7-57 ([#512](https://github.com/sesquicadaver/MTDirector/issues/512)) **DONE**. [`docs/planning/continuous-queue-plan.md`](docs/planning/continuous-queue-plan.md). Pilot (parallel): [`docs/operations/pilot-runbook.md`](docs/operations/pilot-runbook.md) (`Enabled` / `WriteEnabled`).  
