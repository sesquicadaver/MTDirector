...
**Queue (§3.C):** **§3.C NEXT = SEC-12 (#392)** — SEC-11 ([#391](https://github.com/sesquicadaver/MTDirector/issues/391)) **DONE**. [`docs/planning/continuous-queue-plan.md`](docs/planning/continuous-queue-plan.md). Pilot (parallel): [`docs/operations/pilot-runbook.md`](docs/operations/pilot-runbook.md) (`Enabled` / `WriteEnabled`).  
