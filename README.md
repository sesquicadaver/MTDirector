...
**Queue (§3.C):** **§3.C NEXT = residual (CRS lab ops)** — W6-01 ([#352](https://github.com/sesquicadaver/MTDirector/issues/352)) **DONE**. [`docs/planning/continuous-queue-plan.md`](docs/planning/continuous-queue-plan.md). Pilot (parallel): [`docs/operations/pilot-runbook.md`](docs/operations/pilot-runbook.md) (`Enabled` / `WriteEnabled`).  
