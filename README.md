...
**Queue (§3.C):** **§3.C NEXT = W7-54 (#506)** — W7-53 ([#504](https://github.com/sesquicadaver/MTDirector/issues/504)) **DONE**. [`docs/planning/continuous-queue-plan.md`](docs/planning/continuous-queue-plan.md). Pilot (parallel): [`docs/operations/pilot-runbook.md`](docs/operations/pilot-runbook.md) (`Enabled` / `WriteEnabled`).  
