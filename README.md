...
**Queue (§3.C):** **§3.C NEXT = W7-62 (#522)** — W7-61 ([#520](https://github.com/sesquicadaver/MTDirector/issues/520)) **DONE**. [`docs/planning/continuous-queue-plan.md`](docs/planning/continuous-queue-plan.md). Pilot (parallel): [`docs/operations/pilot-runbook.md`](docs/operations/pilot-runbook.md) (`Enabled` / `WriteEnabled`).  
