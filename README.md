...
**Queue (§3.C):** **§3.C NEXT = W7-02 (#402)** — W7-01 ([#401](https://github.com/sesquicadaver/MTDirector/issues/401)) **DONE**. [`docs/planning/continuous-queue-plan.md`](docs/planning/continuous-queue-plan.md). Pilot (parallel): [`docs/operations/pilot-runbook.md`](docs/operations/pilot-runbook.md) (`Enabled` / `WriteEnabled`).  
