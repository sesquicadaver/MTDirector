...
**Queue (§3.C):** **§3.C NEXT = W7-70 (#538)** — W7-69 ([#536](https://github.com/sesquicadaver/MTDirector/issues/536)) **DONE**. [`docs/planning/continuous-queue-plan.md`](docs/planning/continuous-queue-plan.md). Pilot (parallel): [`docs/operations/pilot-runbook.md`](docs/operations/pilot-runbook.md) (`Enabled` / `WriteEnabled`).  
