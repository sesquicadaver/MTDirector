...
**Queue (§3.C):** **§3.C NEXT = W7-69 (#536)** — W7-68 ([#534](https://github.com/sesquicadaver/MTDirector/issues/534)) **DONE**. [`docs/planning/continuous-queue-plan.md`](docs/planning/continuous-queue-plan.md). Pilot (parallel): [`docs/operations/pilot-runbook.md`](docs/operations/pilot-runbook.md) (`Enabled` / `WriteEnabled`).  
