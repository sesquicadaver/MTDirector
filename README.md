...
**Queue (§3.C):** **§3.C NEXT = W7-98 (#594)** — W7-97 ([#593](https://github.com/sesquicadaver/MTDirector/issues/593)) **DONE**; PLAN-08 **COMPLETE**; seeded PLAN-09; PLAN-07 **COMPLETE**; PLAN-06 **COMPLETE**; PLAN-05 **COMPLETE**. [`docs/planning/continuous-queue-plan.md`](docs/planning/continuous-queue-plan.md). Pilot (parallel): [`docs/operations/pilot-runbook.md`](docs/operations/pilot-runbook.md) (`Enabled` / `WriteEnabled`).  
