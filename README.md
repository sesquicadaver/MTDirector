...
**Queue (§3.C):** **§3.C NEXT = W7-64 (#526)** — W7-63 ([#524](https://github.com/sesquicadaver/MTDirector/issues/524)) **DONE**. [`docs/planning/continuous-queue-plan.md`](docs/planning/continuous-queue-plan.md). Pilot (parallel): [`docs/operations/pilot-runbook.md`](docs/operations/pilot-runbook.md) (`Enabled` / `WriteEnabled`).  
