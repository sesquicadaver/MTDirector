...
**Queue (§3.C):** **§3.C NEXT = W7-101 (#600)** — W7-100 ([#598](https://github.com/sesquicadaver/MTDirector/issues/598)) **DONE**; PLAN-09; PLAN-08 **COMPLETE**; PLAN-07 **COMPLETE**; PLAN-06 **COMPLETE**; PLAN-05 **COMPLETE**. [`docs/planning/continuous-queue-plan.md`](docs/planning/continuous-queue-plan.md). Pilot (parallel): [`docs/operations/pilot-runbook.md`](docs/operations/pilot-runbook.md) (`Enabled` / `WriteEnabled`).  
