...
**Queue (§3.C):** **§3.C NEXT = residual (CRS lab ops)** — SEC-03 ([#373](https://github.com/sesquicadaver/MTDirector/issues/373)) **DONE**. [`docs/planning/continuous-queue-plan.md`](docs/planning/continuous-queue-plan.md). Pilot (parallel): [`docs/operations/pilot-runbook.md`](docs/operations/pilot-runbook.md) (`Enabled` / `WriteEnabled`).  
