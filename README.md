...
**Queue (§3.C):** **§3.C NEXT = W7-92 (#582)** — W7-91 ([#580](https://github.com/sesquicadaver/MTDirector/issues/580)) **DONE**; PLAN-07 **COMPLETE**; PLAN-08 inventory; PLAN-06 **COMPLETE**; PLAN-05 **COMPLETE**. [`docs/planning/continuous-queue-plan.md`](docs/planning/continuous-queue-plan.md). Pilot (parallel): [`docs/operations/pilot-runbook.md`](docs/operations/pilot-runbook.md) (`Enabled` / `WriteEnabled`).  
