...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-369 (#1144)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-369 (#1144)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-369 (#1144)", readme, StringComparison.Ordinal);
