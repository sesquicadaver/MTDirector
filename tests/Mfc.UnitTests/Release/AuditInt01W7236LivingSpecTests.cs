...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-333 (#1072)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-333 (#1072)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-333 (#1072)", readme, StringComparison.Ordinal);
