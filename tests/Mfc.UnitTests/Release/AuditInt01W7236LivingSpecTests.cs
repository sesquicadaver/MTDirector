...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-315 (#1036)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-315 (#1036)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-315 (#1036)", readme, StringComparison.Ordinal);
