...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-352 (#1111)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-352 (#1111)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-352 (#1111)", readme, StringComparison.Ordinal);
