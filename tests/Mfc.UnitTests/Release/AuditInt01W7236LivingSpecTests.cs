...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-325 (#1056)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-325 (#1056)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-325 (#1056)", readme, StringComparison.Ordinal);
