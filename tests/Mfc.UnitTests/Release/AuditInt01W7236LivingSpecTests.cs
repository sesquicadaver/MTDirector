...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-326 (#1058)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-326 (#1058)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-326 (#1058)", readme, StringComparison.Ordinal);
