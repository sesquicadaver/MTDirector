...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-281 (#967)", roadmap, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-281 (#967)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-281 (#967)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-281 (#967)", readme, StringComparison.Ordinal);
