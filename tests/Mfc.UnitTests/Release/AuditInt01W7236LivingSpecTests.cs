...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-331 (#1068)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-331 (#1068)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-331 (#1068)", readme, StringComparison.Ordinal);
