...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-381 (#1168)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-381 (#1168)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-381 (#1168)", readme, StringComparison.Ordinal);
