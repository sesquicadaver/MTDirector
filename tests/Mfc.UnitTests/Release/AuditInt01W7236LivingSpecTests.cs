...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-322 (#1050)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-322 (#1050)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-322 (#1050)", readme, StringComparison.Ordinal);
