...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-388 (#1183)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-388 (#1183)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-388 (#1183)", readme, StringComparison.Ordinal);
