...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-378 (#1162)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-378 (#1162)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-378 (#1162)", readme, StringComparison.Ordinal);
