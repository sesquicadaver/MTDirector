...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-298 (#1002)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-298 (#1002)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-298 (#1002)", readme, StringComparison.Ordinal);
