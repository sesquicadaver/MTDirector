...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-368 (#1143)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-368 (#1143)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-368 (#1143)", readme, StringComparison.Ordinal);
