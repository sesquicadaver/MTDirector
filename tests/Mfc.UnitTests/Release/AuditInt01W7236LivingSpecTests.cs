...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-312 (#1031)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-312 (#1031)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-312 (#1031)", readme, StringComparison.Ordinal);
