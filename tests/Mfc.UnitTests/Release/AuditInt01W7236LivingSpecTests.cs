...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-246 (#898)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-246 (#898)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-246 (#898)", readme, StringComparison.Ordinal);
