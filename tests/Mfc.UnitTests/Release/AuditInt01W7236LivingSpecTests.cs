...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-380 (#1167)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-380 (#1167)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-380 (#1167)", readme, StringComparison.Ordinal);
