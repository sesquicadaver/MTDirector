...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-335 (#1076)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-335 (#1076)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-335 (#1076)", readme, StringComparison.Ordinal);
