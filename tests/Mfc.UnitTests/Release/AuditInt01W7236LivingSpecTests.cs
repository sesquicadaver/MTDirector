...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-323 (#1052)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-323 (#1052)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-323 (#1052)", readme, StringComparison.Ordinal);
