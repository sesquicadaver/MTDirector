...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-306 (#1018)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-306 (#1018)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-306 (#1018)", readme, StringComparison.Ordinal);
