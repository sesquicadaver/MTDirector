...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-334 (#1074)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-334 (#1074)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-334 (#1074)", readme, StringComparison.Ordinal);
