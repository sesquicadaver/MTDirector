...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-357 (#1120)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-357 (#1120)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-357 (#1120)", readme, StringComparison.Ordinal);
