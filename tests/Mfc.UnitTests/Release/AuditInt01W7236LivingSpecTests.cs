...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-284 (#975)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-284 (#975)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-284 (#975)", readme, StringComparison.Ordinal);
