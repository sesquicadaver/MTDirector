...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-252 (#910)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-252 (#910)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-252 (#910)", readme, StringComparison.Ordinal);
