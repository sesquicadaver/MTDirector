...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-364 (#1135)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-364 (#1135)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-364 (#1135)", readme, StringComparison.Ordinal);
