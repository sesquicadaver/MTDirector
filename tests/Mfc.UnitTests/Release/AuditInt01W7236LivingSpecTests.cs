...
public sealed class AuditInt01W7236LivingSpecTests
{
    ...
    public void AcDocsQueueAdvancesPastW7237()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-373 (#1152)", plan26, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-373 (#1152)", issues, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-373 (#1152)", readme, StringComparison.Ordinal);
