...
/// <summary>
/// W7-239: known-limitations / queue seed locks DESK-A11Y-SNAP-01 (W7-240) as §3.C NEXT after PLAN-27 inventory.
/// </summary>
public sealed class ProductTrancheSeedW7239LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedDeskA11ySnap01AsNext()
    {
        ...
        Assert.Contains(
            "W7-240 | [#886](https://github.com/sesquicadaver/MTDirector/issues/886) | DESK-A11Y-SNAP-01 — Snapshot Capture/Reload/Compare/Copy AutomationProperties.Name | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-240 (#886)", plan, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-240 (#886)", plan27, StringComparison.Ordinal);
