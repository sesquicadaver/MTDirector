...
public sealed class ProductTrancheSeedW7355LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan53AfterPlan52Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", plan52, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", plan53, StringComparison.Ordinal);
