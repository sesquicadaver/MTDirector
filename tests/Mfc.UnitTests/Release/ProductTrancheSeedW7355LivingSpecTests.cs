...
public sealed class ProductTrancheSeedW7355LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan53AfterPlan52Complete()
    {
        ...
        Assert.Contains(
            "W7-356 | [#1119](https://github.com/sesquicadaver/MTDirector/issues/1119) | PLAN-53 — Inventory Controller fault-correlation logging | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        Assert.Contains(
        ...
        Assert.Contains("§3.C NEXT = W7-356 (#1119)", plan52, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-356 (#1119)", plan53, StringComparison.Ordinal);
