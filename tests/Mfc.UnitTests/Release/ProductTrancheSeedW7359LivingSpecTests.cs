...
public sealed class ProductTrancheSeedW7359LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan54AfterPlan53Complete()
    {
        ...
        Assert.Contains(
            "W7-360 | [#1127](https://github.com/sesquicadaver/MTDirector/issues/1127) | PLAN-54 — Inventory Desktop connection-status fault text | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        Assert.Contains(
            "W7-361 | [#1128](https://github.com/sesquicadaver/MTDirector/issues/1128) | Seed first PLAN-54 atomic row after inventory → DESK-CONN-FAULT-01 | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-360 (#1127)", plan53, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-360 (#1127)", plan54, StringComparison.Ordinal);
