...
/// <summary>
/// W7-394: after PLAN-62 inventory, §3.C NEXT is AUDIT-STATUS-01 (W7-395).
/// </summary>
public sealed class ProductTrancheSeedW7394LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedAuditStatus01AsNext()
    {
        ...
        Assert.Contains(
            "W7-395 | [#1197](https://github.com/sesquicadaver/MTDirector/issues/1197) | AUDIT-STATUS-01 — Honest MVP/M7/write-path status vs audit acd0759 | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-395 (#1197)", plan62, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-395 (#1197)", readme, StringComparison.Ordinal);
    }
