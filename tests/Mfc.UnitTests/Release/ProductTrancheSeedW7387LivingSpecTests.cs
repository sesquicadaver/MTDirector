...
public sealed class ProductTrancheSeedW7387LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan61AfterPlan60Complete()
    {
        ...
        Assert.Contains(
            "W7-388 | [#1183](https://github.com/sesquicadaver/MTDirector/issues/1183) | PLAN-61 — Inventory Desktop connection Disconnected RPC fault text | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        Assert.Contains(
            "W7-389 | [#1184](https://github.com/sesquicadaver/MTDirector/issues/1184) | Seed first PLAN-61 atomic row after inventory → DESK-CONN-DISC-01 | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-388 (#1183)", plan60, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-388 (#1183)", plan61, StringComparison.Ordinal);
