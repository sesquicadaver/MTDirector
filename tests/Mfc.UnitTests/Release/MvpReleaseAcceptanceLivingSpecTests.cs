...
public sealed class MvpReleaseAcceptanceLivingSpecTests
{
    ...
    /// <summary>M0–M6 + N1-07 closed in ROADMAP / ISSUES; MVP CLOSED; post-MVP queue advances past M7.1-01.</summary>
    [Fact]
    public void Ac1M0ThroughM6IssuesAreClosedInRoadmap()
    {
        ...
        Assert.Contains("M7.1-01 DONE", roadmap, StringComparison.Ordinal);
        Assert.Contains("NEXT = M7.1-02", roadmap, StringComparison.Ordinal);
