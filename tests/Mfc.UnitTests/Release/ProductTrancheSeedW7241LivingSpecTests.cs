...
/// <summary>
/// W7-241: known-limitations / queue seed locks DESK-A11Y-PANEL-01 (W7-242) as §3.C NEXT after SNAP-01;
/// follow-up W7-243 PLAN-27 COMPLETE seed opened.
/// </summary>
public sealed class ProductTrancheSeedW7241LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedDeskA11yPanel01AsNext()
    {
        ...
        Assert.Contains(
            "W7-242 | [#891](https://github.com/sesquicadaver/MTDirector/issues/891) | DESK-A11Y-PANEL-01 — Node Refresh / Validate / Drift / Audit Refresh AutomationProperties.Name | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        Assert.Contains(
            "W7-243 | [#892](https://github.com/sesquicadaver/MTDirector/issues/892) | Seed next after DESK-A11Y-PANEL-01 (PLAN-27 COMPLETE) | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        ...
        Assert.Contains("W7-243", plan, StringComparison.Ordinal);
        ...
        Assert.Contains("W7-242 (#891)", plan27, StringComparison.Ordinal);
        Assert.Contains("W7-243 (#892)", plan27, StringComparison.Ordinal);
