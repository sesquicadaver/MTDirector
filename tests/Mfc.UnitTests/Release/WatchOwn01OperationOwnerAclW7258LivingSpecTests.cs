...
public sealed class WatchOwn01OperationOwnerAclW7258LivingSpecTests
{
    ...
    public void Ac3DocsAdvanceNextToWatchBp01Seed()
    {
        ...
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", plan30, StringComparison.Ordinal);
        Assert.Contains("W7-258", continuous, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", continuous, StringComparison.Ordinal);
