...
/// <summary>
/// W7-361: known-limitations / queue seed locked DESK-CONN-FAULT-01 (W7-362) after PLAN-54 inventory.
/// </summary>
public sealed class ProductTrancheSeedW7361LivingSpecTests
{
    [Fact]
    public void Ac1KnownLimitationsAndQueueSeedDeskConnFault01AsNext()
    {
        ...
        Assert.Contains("Intentional residual (W7-361 Living Spec lock)", limitations, StringComparison.Ordinal);
        ...
        Assert.Contains("W7-363", limitations, StringComparison.Ordinal);
        Assert.Contains("seeded as **W7-362**", limitations, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-368 (#1143)", plan54, StringComparison.Ordinal);
