...
public sealed class ProductTrancheSeedW7307LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan41AfterPlan40Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-318 (#1042)", plan40, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-318 (#1042)", plan, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-318 (#1042)", plan41, StringComparison.Ordinal);
