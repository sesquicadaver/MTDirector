...
public sealed class ProductTrancheSeedW7287LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan36AfterPlan35Complete()
    {
        ...
        Assert.Contains(
            "W7-288 | [#983](https://github.com/sesquicadaver/MTDirector/issues/983) | PLAN-36 — Inventory Controller host-template publish bundling (package-controller copies systemd/WinSW into OUT_DIR/controller) | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        Assert.Contains(
        ...
        Assert.Contains("Inventory **OPEN**", plan36, StringComparison.Ordinal);
        Assert.Contains("W7-288", plan36, StringComparison.Ordinal);
        Assert.Contains("W7-289", plan36, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-288 (#983)", plan36, StringComparison.Ordinal);
        ...
        Assert.Contains("d84f8269", plan36, StringComparison.Ordinal);
