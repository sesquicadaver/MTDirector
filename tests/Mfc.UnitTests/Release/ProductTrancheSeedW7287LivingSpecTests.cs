...
public sealed class ProductTrancheSeedW7287LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan36AfterPlan35Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-301 (#1008)", plan35, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-301 (#1008)", plan, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-301 (#1008)", plan36, StringComparison.Ordinal);
