...
public sealed class ProductTrancheSeedW7321LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedCtrlHttpOtelTrace01AsNext()
    {
        ...
        Assert.Contains(
            ...
            StringComparison.Ordinal);
        Assert.Contains(
            "W7-323 | [#1052](https://github.com/sesquicadaver/MTDirector/issues/1052) | Seed next after CTRL-HTTP-OTEL-TRACE-01 (PLAN-44 COMPLETE) | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-322 (#1050)", plan44, StringComparison.Ordinal);
