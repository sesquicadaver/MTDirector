...
public sealed class ProductTrancheSeedW7321LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedCtrlHttpOtelTrace01AsNext()
    {
        ...
        Assert.Contains(
            ...
            roadmap,
            StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-323 (#1052)", roadmap, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-323 (#1052)", plan, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-323 (#1052)", plan44, StringComparison.Ordinal);
