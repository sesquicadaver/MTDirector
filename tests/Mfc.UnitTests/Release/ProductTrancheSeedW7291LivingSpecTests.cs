...
public sealed class ProductTrancheSeedW7291LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan37AfterPlan36Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", plan36, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", plan37, StringComparison.Ordinal);
