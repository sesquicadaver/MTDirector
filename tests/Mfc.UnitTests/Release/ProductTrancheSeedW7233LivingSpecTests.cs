...
public sealed class ProductTrancheSeedW7233LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedAuditAuth01AsNext()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-234 (#875)", roadmap, StringComparison.Ordinal);
        Assert.Contains(
            "W7-234 | [#875](https://github.com/sesquicadaver/MTDirector/issues/875) | AUDIT-AUTH-01 — Production operator authorization DenyAll | **OPEN**",
            roadmap,
        ...
        Assert.Contains("§3.C NEXT = W7-234 (#875)", plan26, StringComparison.Ordinal);
