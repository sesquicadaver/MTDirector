...
public sealed class ProductTrancheSeedW7277LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan34AfterPlan33Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-299 (#1004)", plan33, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-299 (#1004)", plan, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-299 (#1004)", plan34, StringComparison.Ordinal);
