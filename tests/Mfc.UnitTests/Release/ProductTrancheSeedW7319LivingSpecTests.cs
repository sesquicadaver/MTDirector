...
public sealed class ProductTrancheSeedW7319LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan44AfterPlan43Complete()
    {
        ...
        Assert.Contains(
            ...
            StringComparison.Ordinal);
        Assert.Contains(
            "W7-322 | [#1050](https://github.com/sesquicadaver/MTDirector/issues/1050) | CTRL-HTTP-OTEL-TRACE-01 — Controller opt-in OpenTelemetry tracing beyond metrics scrape | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-321 (#1048)", roadmap, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-321 (#1048)", plan43, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-321 (#1048)", plan, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-321 (#1048)", plan44, StringComparison.Ordinal);
