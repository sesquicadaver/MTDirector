...
public sealed class ProductTrancheSeedW7319LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan44AfterPlan43Complete()
    {
        ...
        Assert.Contains(
            "W7-320 | [#1047](https://github.com/sesquicadaver/MTDirector/issues/1047) | PLAN-44 — Inventory Controller OpenTelemetry tracing beyond metrics scrape | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        Assert.Contains(
            "W7-321 | [#1048](https://github.com/sesquicadaver/MTDirector/issues/1048) | Seed first PLAN-44 atomic row after inventory → CTRL-HTTP-OTEL-TRACE-01 | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-320 (#1047)", roadmap, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-320 (#1047)", plan43, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-320 (#1047)", plan, StringComparison.Ordinal);
        ...
        Assert.Contains("Inventory **OPEN**", plan44, StringComparison.Ordinal);
        Assert.Contains("W7-320", plan44, StringComparison.Ordinal);
        Assert.Contains("W7-321", plan44, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-320 (#1047)", plan44, StringComparison.Ordinal);
        Assert.Contains("6596cae1", plan44, StringComparison.Ordinal);
        ...
        Assert.DoesNotContain("WithTracing", program, StringComparison.Ordinal);
    }
