...
public sealed class ProductTrancheSeedW7283LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan35AfterPlan34Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-311 (#1028)", plan34, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-311 (#1028)", plan, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-311 (#1028)", plan35, StringComparison.Ordinal);
