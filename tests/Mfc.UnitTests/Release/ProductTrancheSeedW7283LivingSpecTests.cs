...
public sealed class ProductTrancheSeedW7283LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan35AfterPlan34Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", plan34, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", plan35, StringComparison.Ordinal);
