...
public sealed class ProductTrancheSeedW7311LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan42AfterPlan41Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", plan41, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", plan42, StringComparison.Ordinal);
