...
/// <summary>
/// W7-404: after AUDIT-EVID-01, §3.C NEXT is AUDIT-RB-01 (W7-405).
/// </summary>
public sealed class ProductTrancheSeedW7404LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedAuditRb01AsNext()
    {
        ...
        Assert.Contains(
            "W7-405 | [#1212](https://github.com/sesquicadaver/MTDirector/issues/1212) | AUDIT-RB-01 — Unified strict rollback | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-405 (#1212)", readme, StringComparison.Ordinal);
    }
