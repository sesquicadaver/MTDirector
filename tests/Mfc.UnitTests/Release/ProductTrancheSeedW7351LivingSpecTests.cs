...
public sealed class ProductTrancheSeedW7351LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan52AfterPlan51Complete()
    {
        ...
        Assert.Contains(
            "W7-352 | [#1111](https://github.com/sesquicadaver/MTDirector/issues/1111) | PLAN-52 — Inventory Desktop gRPC ErrorDetail operator mapping | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        Assert.Contains(
        ...
        Assert.Contains("§3.C NEXT = W7-352 (#1111)", plan51, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-352 (#1111)", plan52, StringComparison.Ordinal);
