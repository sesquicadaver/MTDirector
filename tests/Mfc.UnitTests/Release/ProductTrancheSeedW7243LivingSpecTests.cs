...
public sealed class ProductTrancheSeedW7243LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan28AfterPlan27Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-313 (#1032)", plan27, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-313 (#1032)", plan, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-313 (#1032)", plan28, StringComparison.Ordinal);
