...
public sealed class ProductTrancheSeedW7243LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan28AfterPlan27Complete()
    {
        ...
        Assert.Contains(
            "W7-244 | [#895](https://github.com/sesquicadaver/MTDirector/issues/895) | PLAN-28 — Inventory Desktop residual field/control AutomationProperties tranche after PLAN-27 | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        Assert.Contains(
            "W7-245 | [#896](https://github.com/sesquicadaver/MTDirector/issues/896) | Seed first PLAN-28 atomic row after inventory | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-244 (#895)", roadmap, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-244 (#895)", plan27, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-244 (#895)", plan, StringComparison.Ordinal);
        ...
        Assert.Contains("Inventory **OPEN**", plan28, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-244 (#895)", plan28, StringComparison.Ordinal);
