...
/// Historical: inventory DONE; FIELD/CTRL opened; NEXT advanced to W7-245.
/// </summary>
public sealed class ProductTrancheSeedW7243LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan28AfterPlan27Complete()
    {
        ...
        Assert.Contains(
            ...
            StringComparison.Ordinal);
        Assert.Contains(
            "W7-245 | [#896](https://github.com/sesquicadaver/MTDirector/issues/896) | Seed first PLAN-28 atomic row after inventory → DESK-A11Y-FIELD-01 | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-245 (#896)", roadmap, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-245 (#896)", plan27, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-245 (#896)", plan, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-245 (#896)", plan28, StringComparison.Ordinal);
