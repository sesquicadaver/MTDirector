...
public sealed class ProductTrancheSeedW7243LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan28AfterPlan27Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", plan27, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", plan28, StringComparison.Ordinal);
