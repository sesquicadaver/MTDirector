...
public sealed class ProductTrancheSeedW7267LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan32AfterPlan31Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-273 (#952)", plan31, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-273 (#952)", plan, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-273 (#952)", plan32, StringComparison.Ordinal);
