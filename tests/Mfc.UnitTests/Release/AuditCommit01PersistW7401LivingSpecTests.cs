...
public sealed class AuditCommit01PersistW7401LivingSpecTests
{
    ...
    public void Ac2RuntimeAndStartWireCommitEvidenceAndQueueLock()
    {
        ...
        Assert.Contains(
            ...
            StringComparison.Ordinal);
        Assert.Contains(
            "W7-403 | [#1209](https://github.com/sesquicadaver/MTDirector/issues/1209) | AUDIT-EVID-01 — Real safety evidence (no AllSafeEvidence) | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-403 (#1209)", continuous, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-403 (#1209)", issues, StringComparison.Ordinal);
    }
