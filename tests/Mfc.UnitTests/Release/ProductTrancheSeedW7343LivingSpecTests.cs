...
public sealed class ProductTrancheSeedW7343LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan50AfterPlan49Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", plan49, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", plan50, StringComparison.Ordinal);
