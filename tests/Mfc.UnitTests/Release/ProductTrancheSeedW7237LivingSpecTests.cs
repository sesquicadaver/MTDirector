...
/// and follow-up seed W7-239 after AUDIT-INT-01. Historical: inventory DONE; seed W7-239 DONE; SNAP-01 W7-240 DONE; NEXT advanced to W7-243.
/// </summary>
public sealed class ProductTrancheSeedW7237LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan27AfterPlan26Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-243 (#892)", plan26, StringComparison.Ordinal);
