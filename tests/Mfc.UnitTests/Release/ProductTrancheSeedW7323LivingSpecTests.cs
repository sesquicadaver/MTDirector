...
public sealed class ProductTrancheSeedW7323LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan45AfterPlan44Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", plan44, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", plan45, StringComparison.Ordinal);
