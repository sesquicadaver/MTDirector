...
public sealed class ProductTrancheSeedW7255LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan30AfterPlan29Complete()
    {
        ...
        Assert.Contains(
            "W7-256 | [#919](https://github.com/sesquicadaver/MTDirector/issues/919) | PLAN-30 — Inventory Watch operation-owner ACL / hub slow-subscriber backpressure (AUDIT §19 residual) | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        Assert.Contains(
            "W7-257 | [#920](https://github.com/sesquicadaver/MTDirector/issues/920) | Seed first PLAN-30 atomic row after inventory | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-256 (#919)", plan29, StringComparison.Ordinal);
        ...
        Assert.Contains("Inventory **OPEN**", plan30, StringComparison.Ordinal);
        Assert.Contains("§3.C NEXT = W7-256 (#919)", plan30, StringComparison.Ordinal);
