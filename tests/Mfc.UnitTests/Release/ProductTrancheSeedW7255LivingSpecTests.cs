...
public sealed class ProductTrancheSeedW7255LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan30AfterPlan29Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-285 (#976)", plan29, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-285 (#976)", plan, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-285 (#976)", plan30, StringComparison.Ordinal);
