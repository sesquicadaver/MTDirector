...
public sealed class AuditCap03FullCaptureProjectionW7411LivingSpecTests
{
    ...
    public void Ac1FullFacilityRoutingDynamicFilterAndStrictMapRecord()
    {
        ...
        Assert.Contains("W7-412 (#1224) OPEN (NEXT)", plan62, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-412 (#1224)", continuous, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-412 (#1224)", issues, StringComparison.Ordinal);
    }
