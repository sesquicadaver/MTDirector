...
public sealed class ProductTrancheSeedW7249LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan29AfterPlan28Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-267 (#940)", plan28, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-267 (#940)", plan, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-267 (#940)", plan29, StringComparison.Ordinal);
