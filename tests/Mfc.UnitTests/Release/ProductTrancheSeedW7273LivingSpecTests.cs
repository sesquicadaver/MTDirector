...
public sealed class ProductTrancheSeedW7273LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan33AfterPlan32Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = W7-306 (#1018)", plan32, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-306 (#1018)", plan, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-306 (#1018)", plan33, StringComparison.Ordinal);
