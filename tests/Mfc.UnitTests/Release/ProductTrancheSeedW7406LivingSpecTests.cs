...
public sealed class ProductTrancheSeedW7406LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedAuditClk01AsNext()
    {
        ...
        Assert.Contains(
            "W7-407 | [#1215](https://github.com/sesquicadaver/MTDirector/issues/1215) | AUDIT-CLK-01 — RouterOS clock / TTL budget | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = W7-407 (#1215)", readme, StringComparison.Ordinal);
    }
