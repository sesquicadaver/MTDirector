...
/// <summary>
/// W7-329: known-limitations / queue seed locked CTRL-HTTP-OTEL-RESOURCE-01 (W7-330) after PLAN-46 inventory.
/// </summary>
public sealed class ProductTrancheSeedW7329LivingSpecTests
{
    [Fact]
    public void Ac1KnownLimitationsAndQueueSeedCtrlHttpOtelResource01AsNext()
    {
        ...
        Assert.Contains("Intentional residual (W7-329 Living Spec lock)", limitations, StringComparison.Ordinal);
        ...
        Assert.Contains("W7-331", limitations, StringComparison.Ordinal);
        Assert.Contains("seeded as **W7-330**", limitations, StringComparison.Ordinal);
        ...
        Assert.Contains(
            ...
            StringComparison.Ordinal);
        Assert.Contains(
            "W7-340 | [#1087](https://github.com/sesquicadaver/MTDirector/issues/1087) | PLAN-49 — Inventory Controller/Desktop gRPC HTTP/2 keepalive after Kestrel body limits | **OPEN**",
            roadmap,
            StringComparison.Ordinal);
        Assert.Contains(
        ...
        Assert.Contains("§3.C NEXT = W7-340 (#1087)", plan46, StringComparison.Ordinal);
