...
public sealed class ProductTrancheSeedW7379LivingSpecTests
{
    ...
    public void Ac1KnownLimitationsAndQueueSeedPlan59AfterPlan58Complete()
    {
        ...
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", plan58, StringComparison.Ordinal);
        ...
        Assert.Contains("§3.C NEXT = none (queue exhausted; W7-392 #1191 DONE)", plan59, StringComparison.Ordinal);
