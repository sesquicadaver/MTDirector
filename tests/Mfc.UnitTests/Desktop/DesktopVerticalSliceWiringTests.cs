...
public sealed class DesktopVerticalSliceWiringTests
{
    ...
    public void ShellExposesInventorySnapshotDiffZonesPoliciesOnboardingDeploymentDriftAndAudit()
    {
        ...
        Assert.Contains(properties, p => p.Name == nameof(ShellViewModel.Incident)
                                         && p.PropertyType == typeof(IncidentViewModel));
    ...
    public void DesktopClientsCoverInventorySnapshotCompareZonePolicyOnboardingDeploymentDriftAndAuditRpcs()
    {
        ...
        Assert.NotNull(policies.GetMethod(nameof(IPolicyServiceClient.GetDevicePolicySafetyAnalysisAsync)));
        ...
        Type incident = typeof(IIncidentServiceClient);
        Assert.NotNull(incident.GetMethod(nameof(IIncidentServiceClient.IngestIncidentSignalAsync)));
        Assert.NotNull(incident.GetMethod(nameof(IIncidentServiceClient.BindIncidentResponseAssessmentAsync)));
    }
}
