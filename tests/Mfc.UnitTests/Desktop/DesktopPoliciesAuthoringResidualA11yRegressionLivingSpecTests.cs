...
/// <summary>DESK-A11Y-POLICY-EDIT-02 / W7-187: authoring residual + lifecycle + Connect/Disconnect + Incident Names; PLAN-21 COMPLETE.</summary>
public sealed class DesktopPoliciesAuthoringResidualA11yRegressionLivingSpecTests
{
    [Fact]
    public void Ac1AuthoringResidualLifecycleAndShellIncidentActionNamesMatrixLocked()
    {
    ...
    [Fact]
    public void Ac2Plan21CompleteAndDocsLockA11yPolicyEdit02()
    {
        ...
        Assert.Contains("Intentional residual (W7-187 Living Spec lock)", limitations, StringComparison.Ordinal);
    }
