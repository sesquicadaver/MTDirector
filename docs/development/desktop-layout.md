...
**PLAN-13 / DESK-LAYOUT-00…06.** Shared Avalonia resources and Snapshot / Semantic Diff / Drift density contracts for operator-readable data panes.
...
3. Later DESK-LAYOUT-07…09 rows migrate remaining magic heights to these tokens and add `GridSplitter` where needed.
