...
| W5 | W5-01…03 **DONE**; W6-01 **DONE**; residual CRS lab ops |
...
**NEXT (alignment / §3):** **§3.C NEXT = residual (CRS lab ops)**. W6-01 operator-readable Diff/Snapshot **DONE**. Physical CRS runner stays ops (`known-limitations.md`), not a §3 product row.
