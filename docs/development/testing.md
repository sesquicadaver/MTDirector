...
## Living Specification — Continuous residual seed after CI billing (W7-33)

Issue [#464](https://github.com/sesquicadaver/MTDirector/issues/464) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed Desktop window residual as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md` | `ContinuousResidualSeedW733LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDesktopWindowResidualAsNext` |
...
## Living Specification — Product tranche seed after PLAN-03 (W7-57)

Issue [#512](https://github.com/sesquicadaver/MTDirector/issues/512) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-04 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md` | `ProductTrancheSeedW757LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan04AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW757"`.

## Living Specification — Product tranche seed after PLAN-04 (W7-65)

Issue [#528](https://github.com/sesquicadaver/MTDirector/issues/528) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-05 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-04-contract-tests.md` | `ProductTrancheSeedW765LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan05AsNext` |
...
## Living Specification — Product tranche seed after PLAN-06 (W7-77)

Issue [#552](https://github.com/sesquicadaver/MTDirector/issues/552) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-07 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-06-incident-desktop-operator-surface.md` | `ProductTrancheSeedW777LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan07AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW777"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-LAYOUT-03 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-13-desktop-layout-density.md` | `ProductTrancheSeedW7132LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskLayout03AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7132"`.

## Living Specification — Product tranche seed after DESK-LAYOUT-03 (W7-134)

Issue [#671](https://github.com/sesquicadaver/MTDirector/issues/671) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-LAYOUT-04 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-13-desktop-layout-density.md` | `ProductTrancheSeedW7134LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskLayout04AsNext` |
...
## Living Specification — Product tranche seed after DESK-LAYOUT-04 (W7-136)

Issue [#675](https://github.com/sesquicadaver/MTDirector/issues/675) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-LAYOUT-05 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-13-desktop-layout-density.md` | `ProductTrancheSeedW7136LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskLayout05AsNext` |
...
## Living Specification — Product tranche seed after DESK-LAYOUT-05 (W7-138)

Issue [#679](https://github.com/sesquicadaver/MTDirector/issues/679) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-LAYOUT-06 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-13-desktop-layout-density.md` | `ProductTrancheSeedW7138LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskLayout06AsNext` |
...
## Living Specification — Product tranche seed after DESK-LAYOUT-07 (W7-142)

Issue [#687](https://github.com/sesquicadaver/MTDirector/issues/687) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-LAYOUT-08 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-13-desktop-layout-density.md` | `ProductTrancheSeedW7142LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskLayout08AsNext` |
...
## Living Specification — Product tranche seed after DESK-LAYOUT-08 (W7-144)

Issue [#691](https://github.com/sesquicadaver/MTDirector/issues/691) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-LAYOUT-09 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-13-desktop-layout-density.md` | `ProductTrancheSeedW7144LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskLayout09AsNext` |
...
## Living Specification — Product tranche seed after DESK-LAYOUT-09 (W7-146)

Issue [#695](https://github.com/sesquicadaver/MTDirector/issues/695) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-LAYOUT-10 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-13-desktop-layout-density.md` | `ProductTrancheSeedW7146LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskLayout10AsNext` |
...
## Living Specification — Product tranche seed after PLAN-13 (W7-148)

Issue [#699](https://github.com/sesquicadaver/MTDirector/issues/699) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-14 inventory as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-14-…` | `ProductTrancheSeedW7148LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan14InventoryAsNext` |
...
## Living Specification — Product tranche seed after PLAN-14 (W7-153)

Issue [#709](https://github.com/sesquicadaver/MTDirector/issues/709) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-15 inventory as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-15 | `ProductTrancheSeedW7153LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan15InventoryAsNext` |
...
## Living Specification — Product tranche seed after DESK-FIELD-01 (W7-156)

Issue [#714](https://github.com/sesquicadaver/MTDirector/issues/714) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-FIELD-02 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-15 | `ProductTrancheSeedW7156LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskField02AsNext` |
...
## Living Specification — Product tranche seed after PLAN-15 (W7-158)

Issue [#719](https://github.com/sesquicadaver/MTDirector/issues/719) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-16 inventory as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-16 | `ProductTrancheSeedW7158LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan16InventoryAsNext` |
...
## Living Specification — Product tranche seed after DESK-A11Y-01 (W7-161)

Issue [#724](https://github.com/sesquicadaver/MTDirector/issues/724) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-A11Y-02 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-16 | `ProductTrancheSeedW7161LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskA11y02AsNext` |
...
## Living Specification — Product tranche seed after PLAN-16 (W7-163)

Issue [#729](https://github.com/sesquicadaver/MTDirector/issues/729) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-17 inventory as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-17 | `ProductTrancheSeedW7163LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan17InventoryAsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7163"`.

## Living Specification — PLAN-17 Desktop Incident bind-action AutomationProperties inventory (W7-164)

Issue [#730](https://github.com/sesquicadaver/MTDirector/issues/730) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| PLAN-17 inventory + DESK-A11Y-ACTION-01 seed | `docs/planning/plan-17-desktop-incident-bind-action-automation.md`, known-limitations, ROADMAP, continuous plan, docs index | `Plan17DesktopIncidentBindActionW7164LivingSpecTests.Ac1Plan17InventoryDocumentsRankedRowsAndSeedsDeskA11yAction01` |
...
## Living Specification — Product tranche seed after DESK-A11Y-ACTION-01 (W7-166)

Issue [#734](https://github.com/sesquicadaver/MTDirector/issues/734) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-A11Y-ACTION-02 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-17 | `ProductTrancheSeedW7166LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskA11yAction02AsNext` |
...
## Living Specification — Product tranche seed after PLAN-17 (W7-168)

Issue [#739](https://github.com/sesquicadaver/MTDirector/issues/739) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-18 inventory as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-18 | `ProductTrancheSeedW7168LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan18InventoryAsNext` |
...
## Living Specification — Product tranche seed after DESK-A11Y-CONN-01 (W7-176)

Issue [#754](https://github.com/sesquicadaver/MTDirector/issues/754) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-A11Y-CONN-02 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-19 | `ProductTrancheSeedW7176LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskA11yConn02AsNext` |
...
## Living Specification — Product tranche seed after PLAN-19 (W7-178)

Issue [#759](https://github.com/sesquicadaver/MTDirector/issues/759) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-20 inventory as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-20 | `ProductTrancheSeedW7178LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan20InventoryAsNext` |
...
## Living Specification — Product tranche seed after DESK-A11Y-POLICY-01 (W7-181)

Issue [#764](https://github.com/sesquicadaver/MTDirector/issues/764) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-A11Y-POLICY-02 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-20 | `ProductTrancheSeedW7181LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskA11yPolicy02AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7181"`.

## Living Specification — DESK-A11Y-POLICY-02 Policies lifecycle a11y regression / PLAN-20 COMPLETE (W7-182)

Issue [#767](https://github.com/sesquicadaver/MTDirector/issues/767) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| Policies lifecycle + Connect/Disconnect + Incident Names matrix | `MainWindow.axaml` | `DesktopPoliciesLifecycleActionA11yRegressionLivingSpecTests.Ac1PoliciesLifecycleAndShellIncidentActionNamesMatrixLocked` |
| PLAN-20 COMPLETE + docs lock | plan-20 + testing + known-limitations | `DesktopPoliciesLifecycleActionA11yRegressionLivingSpecTests.Ac2Plan20CompleteAndDocsLockA11yPolicy02` |
| CT wrapper | release Living Spec | `CtDeskA11yPolicy02DesktopPoliciesLifecycleActionA11yRegressionLivingSpecTests.Ac1DesktopPoliciesLifecycleActionA11yRegressionLivingSpecAndPlan20CompleteExist` |

Filter: `dotnet test --filter "FullyQualifiedName~DesktopPoliciesLifecycleActionA11yRegressionLivingSpecTests|CtDeskA11yPolicy02"`.

## Living Specification — Product tranche seed after PLAN-20 (W7-183)

Issue [#769](https://github.com/sesquicadaver/MTDirector/issues/769) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-21 inventory as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-21 | `ProductTrancheSeedW7183LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan21InventoryAsNext` |
...
## Living Specification — Product tranche seed after DESK-A11Y-POLICY-EDIT-01 (W7-186)

Issue [#774](https://github.com/sesquicadaver/MTDirector/issues/774) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-A11Y-POLICY-EDIT-02 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-21 | `ProductTrancheSeedW7186LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskA11yPolicyEdit02AsNext` |
...
## Living Specification — Product tranche seed after PLAN-21 (W7-188)

Issue [#779](https://github.com/sesquicadaver/MTDirector/issues/779) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-22 inventory as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-22 | `ProductTrancheSeedW7188LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan22InventoryAsNext` |
...
## Living Specification — Product tranche seed after DESK-A11Y-POLICY-ACK-01 (W7-191)

Issue [#784](https://github.com/sesquicadaver/MTDirector/issues/784) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-A11Y-POLICY-ACK-02 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-22 | `ProductTrancheSeedW7191LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskA11yPolicyAck02AsNext` |
...
## Living Specification — Product tranche seed after PLAN-22 (W7-193)

Issue [#789](https://github.com/sesquicadaver/MTDirector/issues/789) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-23 inventory as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-23 | `ProductTrancheSeedW7193LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan23InventoryAsNext` |
...
## Living Specification — Product tranche seed after DESK-A11Y-POLICY-OBJ-01 (W7-196)

Issue [#794](https://github.com/sesquicadaver/MTDirector/issues/794) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-A11Y-POLICY-OBJ-02 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-23 | `ProductTrancheSeedW7196LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskA11yPolicyObj02AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7196"`.

## Living Specification — DESK-A11Y-POLICY-OBJ-02 catalog/object a11y regression / PLAN-23 COMPLETE (W7-197)

Issue [#797](https://github.com/sesquicadaver/MTDirector/issues/797) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| catalog/object + ack/record + authoring residual + lifecycle + Connect/Disconnect + Incident Names matrix | `MainWindow.axaml` | `DesktopPoliciesCatalogObjectA11yRegressionLivingSpecTests.Ac1CatalogObjectAckRecordAuthoringResidualLifecycleAndShellIncidentActionNamesMatrixLocked` |
| PLAN-23 COMPLETE + docs lock | plan-23 + testing + known-limitations | `DesktopPoliciesCatalogObjectA11yRegressionLivingSpecTests.Ac2Plan23CompleteAndDocsLockA11yPolicyObj02` |
| CT wrapper | release Living Spec | `CtDeskA11yPolicyObj02DesktopPoliciesCatalogObjectA11yRegressionLivingSpecTests.Ac1DesktopPoliciesCatalogObjectA11yRegressionLivingSpecAndPlan23CompleteExist` |

Filter: `dotnet test --filter "FullyQualifiedName~DesktopPoliciesCatalogObjectA11yRegressionLivingSpecTests|CtDeskA11yPolicyObj02"`.

## Living Specification — Product tranche seed after PLAN-23 (W7-198)

Issue [#799](https://github.com/sesquicadaver/MTDirector/issues/799) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-24 inventory as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-24 | `ProductTrancheSeedW7198LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan24InventoryAsNext` |
...
## Living Specification — Product tranche seed after AUDIT-GUARD-01 (W7-225)

Issue [#856](https://github.com/sesquicadaver/MTDirector/issues/856) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed AUDIT-DEP-01 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-26 | `ProductTrancheSeedW7225LivingSpecTests.Ac1KnownLimitationsAndQueueSeedAuditDep01AsNext` |
...
## Living Specification — Product tranche seed after AUDIT-DEP-01 (W7-227)

Issue [#860](https://github.com/sesquicadaver/MTDirector/issues/860) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed AUDIT-DEP-02 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-26 | `ProductTrancheSeedW7227LivingSpecTests.Ac1KnownLimitationsAndQueueSeedAuditDep02AsNext` |
...
## Living Specification — Product tranche seed after AUDIT-DEP-03 (W7-231)

Issue [#868](https://github.com/sesquicadaver/MTDirector/issues/868) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed AUDIT-GUI-01 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-26 | `ProductTrancheSeedW7231LivingSpecTests.Ac1KnownLimitationsAndQueueSeedAuditGui01AsNext` |
...
## Living Specification — Product tranche seed after AUDIT-GUI-01 (W7-233)

Issue [#872](https://github.com/sesquicadaver/MTDirector/issues/872) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed AUDIT-AUTH-01 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-26 | `ProductTrancheSeedW7233LivingSpecTests.Ac1KnownLimitationsAndQueueSeedAuditAuth01AsNext` |
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-A11Y-CTRL-01 as NEXT; PLAN-28 COMPLETE follow-up opened | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-28 | `ProductTrancheSeedW7247LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskA11yCtrl01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7247"`.
...
## Living Specification — Product tranche seed PLAN-35 after PLAN-34 COMPLETE (W7-283)

Issue [#972](https://github.com/sesquicadaver/MTDirector/issues/972) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-35 inventory after PLAN-34 COMPLETE | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-34, plan-35 | `ProductTrancheSeedW7283LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan35AfterPlan34Complete` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7283"`.
...
## Living Specification — Product tranche seed PLAN-40 after PLAN-39 COMPLETE (W7-303)

Issue [#1012](https://github.com/sesquicadaver/MTDirector/issues/1012) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| Seed locks PLAN-40 inventory as §3.C NEXT | known-limitations, ROADMAP, plan-39/40, continuous-queue | `ProductTrancheSeedW7303LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan40AfterPlan39Complete` |
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| Seed locks PLAN-38 inventory as §3.C NEXT | known-limitations, ROADMAP, plan-37/38, continuous-queue | `ProductTrancheSeedW7295LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan38AfterPlan37Complete` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7295"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| Seed locks OPS-HOST-ENV-01 as §3.C NEXT | known-limitations, ROADMAP, plan-37, continuous-queue | `ProductTrancheSeedW7293LivingSpecTests.Ac1KnownLimitationsAndQueueSeedOpsHostEnv01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7293"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| Seed locks PLAN-37 inventory as §3.C NEXT | known-limitations, ROADMAP, plan-36/37, continuous-queue | `ProductTrancheSeedW7291LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan37AfterPlan36Complete` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7291"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-A11Y-TREE-01 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-33 | `ProductTrancheSeedW7275LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskA11yTree01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7275"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-A11Y-SNAP-01 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-27 | `ProductTrancheSeedW7239LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskA11ySnap01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7239"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed AUDIT-GUARD-01 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-26 | `ProductTrancheSeedW7223LivingSpecTests.Ac1KnownLimitationsAndQueueSeedAuditGuard01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7223"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed AUDIT-DIFF-01 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-26 | `ProductTrancheSeedW7221LivingSpecTests.Ac1KnownLimitationsAndQueueSeedAuditDiff01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7221"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed AUDIT-AN-02 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-26 | `ProductTrancheSeedW7219LivingSpecTests.Ac1KnownLimitationsAndQueueSeedAuditAn02AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7219"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed AUDIT-AN-01 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-26 | `ProductTrancheSeedW7217LivingSpecTests.Ac1KnownLimitationsAndQueueSeedAuditAn01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7217"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-26 inventory as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-26, audit | `ProductTrancheSeedW7205LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan26AfterPlan25` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7205"`.
...
## Living Specification — Product tranche seed after PLAN-24 (W7-203)

Issue [#809](https://github.com/sesquicadaver/MTDirector/issues/809) AC → module → tests:

| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-25 inventory as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, continuous plan, plan-25 | `ProductTrancheSeedW7203LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan25InventoryAsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7203"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-LAYOUT-02 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-13-desktop-layout-density.md` | `ProductTrancheSeedW7130LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskLayout02AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7130"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-LAYOUT-01 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-13-desktop-layout-density.md` | `ProductTrancheSeedW7128LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskLayout01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7128"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-CATALOG-01 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-12-desktop-policies-residual-lifecycle.md` | `ProductTrancheSeedW7123LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskCatalog01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7123"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-12 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-11-desktop-policies-review-compose-lifecycle.md` | `ProductTrancheSeedW7118LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan12AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7118"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-GATE-01 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-11-desktop-policies-review-compose-lifecycle.md` | `ProductTrancheSeedW7117LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskGate01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7117"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-COMPOSE-01 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-11-desktop-policies-review-compose-lifecycle.md` | `ProductTrancheSeedW7113LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskCompose01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7113"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-11 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-10-desktop-shell-policies-authoring-depth.md` | `ProductTrancheSeedW7111LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan11AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7111"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-REORDER-01 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-10-desktop-shell-policies-authoring-depth.md` | `ProductTrancheSeedW7109LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskReorder01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7109"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-09 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-08-desktop-secondary-operator-surface.md` | `ProductTrancheSeedW797LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan09AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW797"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-POLICY-02 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-08-desktop-secondary-operator-surface.md` | `ProductTrancheSeedW795LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskPolicy02AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW795"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-NBR-01 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-08-desktop-secondary-operator-surface.md` | `ProductTrancheSeedW791LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskNbr01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW791"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed PLAN-08 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-07-core-mvp-desktop-operator-surface.md` | `ProductTrancheSeedW788LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan08AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW788"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-INVENTORY-01 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-07-core-mvp-desktop-operator-surface.md` | `ProductTrancheSeedW786LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskInventory01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW786"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-ONBOARD-01 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-07-core-mvp-desktop-operator-surface.md` | `ProductTrancheSeedW782LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskOnboard01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW782"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| known-limitations + queue seed DESK-DEPLOY-01 as NEXT | `docs/release/known-limitations.md`, `ROADMAP.md`, `docs/planning/continuous-queue-plan.md`, `plan-07-core-mvp-desktop-operator-surface.md` | `ProductTrancheSeedW780LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskDeploy01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW780"`.
...
| AC / вимога | Модуль | Тест |
|-------------|--------|------|
| PLAN-06 inventory + DESK-INCIDENT-01 seed | `docs/planning/plan-06-incident-desktop-operator-surface.md`, `known-limitations.md`, ROADMAP, continuous plan, docs index | `Plan06IncidentDesktopOperatorSurfaceW772LivingSpecTests.Ac1Plan06InventoryDocumentsRankedIncidentRowsAndSeedsDeskIncident01` |
...
## Living Specification — Product tranche seed PLAN-43 after PLAN-42 COMPLETE (W7-315)

| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks PLAN-43 inventory as §3.C NEXT | known-limitations, ROADMAP, plan-42/43, continuous-queue | `ProductTrancheSeedW7315LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan43AfterPlan42Complete` |
...
## Living Specification — Product tranche seed PLAN-45 after PLAN-44 COMPLETE (W7-323)

| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks PLAN-45 inventory as §3.C NEXT | known-limitations, ROADMAP, plan-44/45, continuous-queue | `ProductTrancheSeedW7323LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan45AfterPlan44Complete` |
...
## Living Specification — PLAN-46 inventory Controller OpenTelemetry resource identity (W7-328)

| AC | Normative surface | Living Spec test |
|----|-------------------|------------------|
| PLAN-46 inventory ranks sole CTRL-HTTP-OTEL-RESOURCE-01 + seeds | plan-46, Program.cs, ROADMAP, known-limitations | `Plan46ControllerOtelResourceIdentityW7328LivingSpecTests.Ac1Plan46InventoryDocumentsSoleCtrlHttpOtelResource01RankAndSeedsImplement` |

Filter: `dotnet test --filter "FullyQualifiedName~Plan46ControllerOtelResourceIdentityW7328"`.

## Living Specification — Seed CTRL-HTTP-OTEL-RESOURCE-01 as §3.C NEXT (W7-329)

| AC | Normative surface | Living Spec test |
|----|-------------------|------------------|
| Seed locks CTRL-HTTP-OTEL-RESOURCE-01 as §3.C NEXT | known-limitations, ROADMAP, plan-46, continuous-queue | `ProductTrancheSeedW7329LivingSpecTests.Ac1KnownLimitationsAndQueueSeedCtrlHttpOtelResource01AsNext` |
...
## Living Specification — Seed PLAN-47 after PLAN-46 COMPLETE (W7-331)

| AC | Normative surface | Living Spec test |
|----|-------------------|------------------|
| Seed locks PLAN-47 inventory as §3.C NEXT | known-limitations, ROADMAP, plan-46, plan-47, continuous-queue | `ProductTrancheSeedW7331LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan47AfterPlan46Complete` |
...
## Living Specification — Seed PLAN-48 after PLAN-47 COMPLETE (W7-335)

| AC | Normative surface | Living Spec test |
|----|-------------------|------------------|
| Seed locks PLAN-48 inventory as §3.C NEXT | known-limitations, ROADMAP, plan-47, plan-48, continuous-queue | `ProductTrancheSeedW7335LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan48AfterPlan47Complete` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7335"`.
...
## Living Specification — Seed CTRL-KESTREL-BODY-01 as §3.C NEXT (W7-337)

| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks CTRL-KESTREL-BODY-01 as §3.C NEXT | known-limitations, ROADMAP, plan-48, continuous-queue | `ProductTrancheSeedW7337LivingSpecTests.Ac1KnownLimitationsAndQueueSeedCtrlKestrelBody01AsNext` |
...
## Living Specification — Seed PLAN-49 after PLAN-48 COMPLETE (W7-339)

| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks PLAN-49 inventory as §3.C NEXT | known-limitations, ROADMAP, plan-48, plan-49, continuous-queue | `ProductTrancheSeedW7339LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan49AfterPlan48Complete` |
...
## Living Specification — Seed CTRL-GRPC-KEEPALIVE-01 as §3.C NEXT (W7-341)

| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks CTRL-GRPC-KEEPALIVE-01 as §3.C NEXT | known-limitations, ROADMAP, plan-49, continuous-queue | `ProductTrancheSeedW7341LivingSpecTests.Ac1KnownLimitationsAndQueueSeedCtrlGrpcKeepalive01AsNext` |
...
| AC | Module | Test |
|----|--------|------|
| Seed locks AUDIT-CAP-04 as §3.C NEXT | known-limitations, ROADMAP, plan-62, continuous-queue, README | `ProductTrancheSeedW7412LivingSpecTests.Ac1KnownLimitationsAndQueueSeedAuditCap04AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7412"`.
...
| AC | Module | Test |
|----|--------|------|
| Seed locks AUDIT-CAP-03 as §3.C NEXT | known-limitations, ROADMAP, plan-62, continuous-queue, README | `ProductTrancheSeedW7410LivingSpecTests.Ac1KnownLimitationsAndQueueSeedAuditCap03AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7410"`.
...
| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks DESK-CONN-DISC-01 as §3.C NEXT | known-limitations, ROADMAP, plan-61, continuous-queue, ControllerConnectionService baseline | `ProductTrancheSeedW7389LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskConnDisc01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7389"`.
...
| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks PLAN-61 inventory as §3.C NEXT | known-limitations, ROADMAP, plan-60, plan-61, continuous-queue | `ProductTrancheSeedW7387LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan61AfterPlan60Complete` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7387"`.
...
| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks DESK-SVC-FAULT-01 as §3.C NEXT | known-limitations, ROADMAP, plan-60, continuous-queue | `ProductTrancheSeedW7385LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskSvcFault01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7385"`.
...
| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks PLAN-60 inventory as §3.C NEXT | known-limitations, ROADMAP, plan-59, plan-60, continuous-queue | `ProductTrancheSeedW7383LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan60AfterPlan59Complete` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7383"`.
...
| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks PLAN-59 inventory as §3.C NEXT | known-limitations, ROADMAP, plan-58, plan-59, continuous-queue | `ProductTrancheSeedW7379LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan59AfterPlan58Complete` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7379"`.
...
| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks PLAN-58 inventory as §3.C NEXT | known-limitations, ROADMAP, plan-57, plan-58, continuous-queue | `ProductTrancheSeedW7375LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan58AfterPlan57Complete` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7375"`.
...
| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks DESK-VRRP-PROG-01 as §3.C NEXT | known-limitations, ROADMAP, plan-57, continuous-queue | `ProductTrancheSeedW7373LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskVrrpProg01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7373"`.
...
| Requirement | Artifact | Test |
|-------------|----------|------|
| Pair status repeats DesktopRpcFaultText on RpcException; prior locks held | NodeDetailViewModel, DesktopRpcFaultText, connection-profiles | `DeskVrrpFault01DesktopPairStatusLivingSpecTests` |

Filter: `dotnet test --filter "FullyQualifiedName~DeskVrrpFault01"`.

## Living Specification — Seed DESK-VRRP-FAULT-01 as §3.C NEXT (W7-369)

| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks DESK-VRRP-FAULT-01 as §3.C NEXT | known-limitations, ROADMAP, plan-56, continuous-queue | `ProductTrancheSeedW7369LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskVrrpFault01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7369"`.
...
| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks PLAN-55 inventory as §3.C NEXT | known-limitations, ROADMAP, plan-54, plan-55, continuous-queue | `ProductTrancheSeedW7363LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan55AfterPlan54Complete` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7363"`.
...
| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks DESK-CONN-FAULT-01 as §3.C NEXT | known-limitations, ROADMAP, plan-54, continuous-queue | `ProductTrancheSeedW7361LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskConnFault01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7361"`.
...
| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks PLAN-54 inventory as §3.C NEXT | known-limitations, ROADMAP, plan-53, plan-54, continuous-queue | `ProductTrancheSeedW7359LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan54AfterPlan53Complete` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7359"`.
...
| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks PLAN-53 inventory as §3.C NEXT | known-limitations, ROADMAP, plan-52, plan-53, continuous-queue | `ProductTrancheSeedW7355LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan53AfterPlan52Complete` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7355"`.
...
| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks DESK-GRPC-DEADLINE-01 as §3.C NEXT | known-limitations, ROADMAP, plan-51, continuous-queue | `ProductTrancheSeedW7349LivingSpecTests.Ac1KnownLimitationsAndQueueSeedDeskGrpcDeadline01AsNext` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7349"`.
...
## Living Specification — Product tranche seed PLAN-46 after PLAN-45 COMPLETE (W7-327)

| Requirement | Artifact | Test |
|-------------|----------|------|
| Seed locks PLAN-46 inventory as §3.C NEXT | known-limitations, ROADMAP, plan-45/46, continuous-queue | `ProductTrancheSeedW7327LivingSpecTests.Ac1KnownLimitationsAndQueueSeedPlan46AfterPlan45Complete` |

Filter: `dotnet test --filter "FullyQualifiedName~ProductTrancheSeedW7327"`.
...
**Residuals:** Desktop OUT; compose unchanged. Typed `PolicyDocument.Tests` deferred (opaque JSON so canonical hashes stay stable). Mandatory *generation* of missing user tests for every ACCEPT/FastTrack/exception (§55) is out of scope — this slice evaluates caller-supplied tests. Approval/binding is M2-17 (missing `PolicyEvidenceSignals` is unknown CRITICAL there). Compiler writes are M3. Deploy gating is N1-06. Exception/management/default/zone-binding minimum risk is caller-supplied `PolicyEvidenceSignals` except FastTrack inferred from rule-effect + UUID changes; Diff also sets `DefaultDispositionChanged` from chain contracts (W7-222). NODE_EFFECTIVE actual-filter match is coarse: only exact-host `protocol`/`src-address`/`dst-address`/`connection-state` may Hit or Miss; CIDR/range/list, extra known matchers (`src-port`, interface, …), unknown matchers, and actions outside accept/drop/reject/fasttrack-connection/return are INDETERMINATE. Packet-space classes use separate before/after catalogs and first-match accepted space (earlier terminal DROP/REJECT covers later ACCEPT; W7-222 / AUDIT-DIFF-01 closed the prior union-only residual). M2-12…M2-15 analysis-context preimages are unchanged. Controller never writes tests, policy, or filter rules.
