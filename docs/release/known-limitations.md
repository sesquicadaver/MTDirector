...
- Intentional residual (W7-205 Living Spec lock): §3.C product tranche after PLAN-25 is pre-seeded as **W7-205** / **W7-206** — **PLAN-26** code-audit remediation (`11cb746`); audit in `docs/audits/MTDirector-audit-11cb746-20260911.md`; not idle after PLAN-25; not a lab stop-gate.
