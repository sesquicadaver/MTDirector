...
- Live physical CRS hardware exercise is **OFF**. Scripted CRS fixture + `VrrpCrsE2ELivingSpecTests` AC11 are the DoD substitute. Physical CRS is **ops residual**, not a §3 stop-gate. **§3.C NEXT = SEC-03** ([#373](https://github.com/sesquicadaver/MTDirector/issues/373)) after SEC-02.
