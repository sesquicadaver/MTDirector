...
N1 weave items N1-01…N1-07 are DONE; **MVP CLOSED**. Linear queue continues at **M7.1-05 (#114)** (M7.1-03…M7.1-04 DONE).
...
With M6-01…M6-09 and N1-07 delivered, **M6 is CLOSED** and **MVP CLOSED**. Linear queue continues at **M7.1-05 (#114)** (M7.1-03…M7.1-04 DONE). Do **not** create a git release tag until acceptance review signs off (AC16).
