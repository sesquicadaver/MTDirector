...
**Release baseline:** `v0.2.0` + P2 read path CLOSED + P2-07…P2-10 DONE. **NEXT = P2-11** (#297) — see [`ROADMAP.md`](../../ROADMAP.md) §3.B7.
...
| Remaining delivery order | See ROADMAP v0.2 §3 | **NEXT = P2-11** (#297) |
