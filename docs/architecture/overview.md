...
**Release baseline:** `v0.2.0` + P2 read/write CLOSED + Desktop alignment P0–P2 DONE + CONT-01 DONE. **§3.C NEXT = CONT-02** ([#341](https://github.com/sesquicadaver/MTDirector/issues/341)).
