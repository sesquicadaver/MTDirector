...
**Release baseline:** `v0.2.0` + P2 read path CLOSED + P2-07 DONE. **NEXT = P2-08** (#294) — see [`ROADMAP.md`](../../ROADMAP.md) §3.B7.
...
| Remaining delivery order | See ROADMAP v0.2 §3 | **NEXT = P2-08** (#294) → P2-09…P2-11 |
