...
**Release baseline:** `v0.2.0` + P2 read/write CLOSED + Desktop alignment P0–P2 DONE + CONT-01…02 DONE + W5-01 DONE. **§3.C NEXT = W5-02** ([#343](https://github.com/sesquicadaver/MTDirector/issues/343)).
