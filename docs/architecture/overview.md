...
**Release baseline:** `v0.2.0` + P2 read path CLOSED. **NEXT = P2-07** (#293) — see [`ROADMAP.md`](../../ROADMAP.md) §3.B7.
...
| Remaining delivery order | See ROADMAP v0.2 §3 | **NEXT = P2-07** (#293) → P2-08…P2-11 |
