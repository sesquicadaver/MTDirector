...
**Release baseline:** `v0.2.0` + P2 read path CLOSED + P2-07…P2-08 DONE. **NEXT = P2-09** (#295) — see [`ROADMAP.md`](../../ROADMAP.md) §3.B7.
...
| Remaining delivery order | See ROADMAP v0.2 §3 | **NEXT = P2-09** (#295) → P2-10…P2-11 |
