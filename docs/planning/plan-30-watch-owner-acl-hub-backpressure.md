...
**Status:** Inventory **DONE** (W7-256); seed **W7-257 (#920) DONE**; implement **W7-258 (#922) DONE**; seed **W7-259 (#923) OPEN** (**§3.C NEXT**) → **WATCH-BP-01**  
...
| 2 | **WATCH-BP-01** | Bounded hub subscriber channels / slow-subscriber backpressure + live `_history` cap | `CreateUnbounded` ×3 ProgressHubs; unbounded `_history` while retained | seed **W7-259 (#923) OPEN** (**§3.C NEXT**) (opens BP implement after OWN) |
...
5. **W7-259 OPEN** — seed advances NEXT to **WATCH-BP-01**.
6. Execute WATCH-BP-01 atomically.

## §3.C NEXT

**§3.C NEXT = W7-259 (#923)** — Seed next PLAN-30 row after WATCH-OWN-01 → WATCH-BP-01.
