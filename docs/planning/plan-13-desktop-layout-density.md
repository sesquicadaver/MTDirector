...
**Date:** 2026-09-09  
**Status:** Inventory **DONE** (W7-126); **DESK-LAYOUT-00 DONE** (W7-127); **DESK-LAYOUT-01 DONE** (W7-129); **DESK-LAYOUT-02 DONE** (W7-131); seed **W7-132 DONE** → implement **DESK-LAYOUT-03 OPEN** (W7-133)  
...
| 4 | **DESK-LAYOUT-03** | Drift: competing stars + findings `MaxHeight="200"` | ~1737–1831 | seeded by **W7-132 DONE** (#667) → implement **W7-133 OPEN** (#668) |
...
**§3.C NEXT = W7-133 (#668)** — DESK-LAYOUT-03 Drift events/findings/detail splitter Living Spec depth.
