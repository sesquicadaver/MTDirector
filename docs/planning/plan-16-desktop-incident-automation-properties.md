...
Incident Operations TextBoxes expose `AutomationProperties.Name` matching adjacent operator labels (DESK-A11Y-01). Broader Desktop a11y remains out of scope until later rows.
