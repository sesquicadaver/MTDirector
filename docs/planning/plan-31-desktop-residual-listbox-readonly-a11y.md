...
|---------|------------------|-----|
| Operator ListBox hosts (`ItemsSource`-bound) in `MainWindow.axaml` | **43** hosts: Modules (1), Zones (3), Node (6), RoutingAssurance (3), Snapshot (3), Diff (2), Policies (13), Onboarding (3), Deployment (6), Drift (2), Audit (1) | **0** host-level `AutomationProperties.Name` |
