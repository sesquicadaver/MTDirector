...
**Status:** Inventory **DONE** (W7-262); seed **W7-263 (#932) DONE**; implement **W7-264 (#934) DONE**; seed **W7-265 (#935) OPEN** (**§3.C NEXT**) → **DESK-A11Y-RO-01**  
...
|------|----|-----|----------|-------|
| 1 | **DESK-A11Y-LIST-01** | ListBox host `AutomationProperties.Name` on all 43 `ItemsSource`-bound operator browse/select surfaces | 43 ItemsSource ListBox hosts named (W7-264 DONE); inventory baseline @ `184bb85` | implement **W7-264 (#934) DONE**; seed **W7-263 (#932) DONE**; next seed **W7-265 (#935) OPEN** |
...
5. **W7-265 OPEN** — seed advances NEXT to **DESK-A11Y-RO-01**.

## §3.C NEXT

**§3.C NEXT = W7-265 (#935)** — Seed next PLAN-31 row after DESK-A11Y-LIST-01 → DESK-A11Y-RO-01.
