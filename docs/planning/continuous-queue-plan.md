...
**PLAN-42 (Controller HTTP health probes):** [`plan-42-controller-http-health-probes.md`](plan-42-controller-http-health-probes.md) inventory **W7-312 (#1031) DONE**; seed **W7-313 (#1032) DONE**; implement **W7-314 (#1034) OPEN** (**§3.C NEXT**); COMPLETE **W7-315 (#1036) OPEN**; seeded by **W7-311 DONE** after **PLAN-41 COMPLETE**
...
| 344 | W7-314 | [#1034](https://github.com/sesquicadaver/MTDirector/issues/1034) | CTRL-HTTP-HEALTH-01 — HTTP liveness/readiness probes beyond gRPC health | **OPEN** |
| 345 | W7-315 | [#1036](https://github.com/sesquicadaver/MTDirector/issues/1036) | Seed next after CTRL-HTTP-HEALTH-01 (PLAN-42 COMPLETE) | **OPEN** |
