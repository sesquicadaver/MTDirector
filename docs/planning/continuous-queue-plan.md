...
**PLAN-54 (Desktop connection-status fault text):** [`plan-54-desktop-connection-status-fault-text.md`](plan-54-desktop-connection-status-fault-text.md) inventory **W7-360 (#1127) DONE**; seed **W7-361 (#1128) DONE**; implement **DESK-CONN-FAULT-01 W7-362 (#1130) OPEN** (**§3.C NEXT**); COMPLETE **W7-363 (#1131) OPEN**; seeded by **W7-359 (#1123) DONE** after **PLAN-53 COMPLETE**
