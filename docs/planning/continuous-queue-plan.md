...
**PLAN-32 (Controller host-process packaging templates):** [`plan-32-controller-host-process-packaging.md`](plan-32-controller-host-process-packaging.md) inventory **W7-268 (#943) DONE**; seed **W7-269 (#944) OPEN** (**§3.C NEXT**); implement **W7-270 (#946) OPEN**; seed **W7-271 (#947) OPEN**; seeded by **W7-267 DONE** after **PLAN-31 COMPLETE**
...
| 299 | W7-269 | [#944](https://github.com/sesquicadaver/MTDirector/issues/944) | Seed first PLAN-32 atomic row after inventory → OPS-HOST-SYSTEMD-01 | **OPEN** |
| 300 | W7-270 | [#946](https://github.com/sesquicadaver/MTDirector/issues/946) | OPS-HOST-SYSTEMD-01 — systemd unit template for framework-dependent Controller | **OPEN** |
| 301 | W7-271 | [#947](https://github.com/sesquicadaver/MTDirector/issues/947) | Seed next PLAN-32 row after OPS-HOST-SYSTEMD-01 → OPS-HOST-WINSVC-01 | **OPEN** |
