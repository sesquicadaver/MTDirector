...
**PLAN-37 (Controller host env sample packaging):** [`plan-37-controller-host-env-sample-packaging.md`](plan-37-controller-host-env-sample-packaging.md) inventory **W7-292 (#991) DONE**; seed **W7-293 (#992) OPEN** (**§3.C NEXT**); implement **W7-294 (#994) OPEN**; seeded by **W7-291 DONE** after **PLAN-36 COMPLETE**
...
| 323 | W7-293 | [#992](https://github.com/sesquicadaver/MTDirector/issues/992) | Seed first PLAN-37 atomic row after inventory → OPS-HOST-ENV-01 | **OPEN** |
