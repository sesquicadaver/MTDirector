...
**PLAN-41 (Release signing crypto GPG/Sigstore):** [`plan-41-release-signing-crypto-gpg-sigstore.md`](plan-41-release-signing-crypto-gpg-sigstore.md) inventory **W7-308 (#1023) DONE**; seed **W7-309 (#1024) OPEN** (**§3.C NEXT**); implement **W7-310 (#1026) OPEN**; seeded by **W7-307 DONE** after **PLAN-40 COMPLETE**
