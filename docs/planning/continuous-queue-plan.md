...
| DESK-ZONE-01 — Desktop Zones panel Living Spec vs ZoneGrpcHost | Docs / Desktop Living Spec | **W7-69 OPEN** |
...
W7-69 DESK-ZONE-01 — Desktop Zones panel Living Spec vs ZoneGrpcHost **OPEN**
...
| 99 | W7-69 | [#536](https://github.com/sesquicadaver/MTDirector/issues/536) | DESK-ZONE-01 — Desktop Zones panel Living Spec vs ZoneGrpcHost | **OPEN** |
| 100 | W7-70 | [#538](https://github.com/sesquicadaver/MTDirector/issues/538) | Seed next PLAN-05 row after DESK-ZONE-01 | **OPEN** |

**§3.C NEXT = W7-69 (#536)**. W7-68 **DONE**. CRS/physical lab runner remains ops-parallel ([`known-limitations.md`](../release/known-limitations.md)), not a product §3 stop-gate.
