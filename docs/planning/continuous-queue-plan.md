...
**PLAN-34 (Desktop operator launch packaging templates):** [`plan-34-desktop-operator-launch-packaging.md`](plan-34-desktop-operator-launch-packaging.md) inventory **W7-278 (#963) OPEN** (**§3.C NEXT**); seed **W7-279 (#964) OPEN**; seeded by **W7-277 DONE** after **PLAN-33 COMPLETE** (predecessor **W7-273 DONE** seeded PLAN-33)
...
| 308 | W7-278 | [#963](https://github.com/sesquicadaver/MTDirector/issues/963) | PLAN-34 — Inventory Desktop operator launch packaging templates (.desktop / Windows shortcut) | **OPEN** |
