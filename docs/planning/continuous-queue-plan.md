...
**PLAN-40 (Controller host journald/syslog identity):** [`plan-40-controller-host-journald-syslog-identity.md`](plan-40-controller-host-journald-syslog-identity.md) inventory **W7-304 (#1015) DONE**; seed **W7-305 (#1016) OPEN** (**§3.C NEXT**); implement **W7-306 (#1018) OPEN**; seeded by **W7-303 DONE** after **PLAN-39 COMPLETE**
