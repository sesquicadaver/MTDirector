...
**PLAN-31 (Desktop residual ListBox / Drift–Audit read-only a11y) COMPLETE:** [`plan-31-desktop-residual-listbox-readonly-a11y.md`](plan-31-desktop-residual-listbox-readonly-a11y.md) ranks 1…2 **DONE**; seed **W7-267 DONE**
**PLAN-32 (Controller host-process packaging templates):** [`plan-32-controller-host-process-packaging.md`](plan-32-controller-host-process-packaging.md) inventory **W7-268 (#943) OPEN** (**§3.C NEXT**); seed **W7-269 (#944) OPEN**; seeded by **W7-267 DONE** after **PLAN-31 COMPLETE**
...
| 298 | W7-268 | [#943](https://github.com/sesquicadaver/MTDirector/issues/943) | PLAN-32 — Inventory Controller host-process packaging templates (systemd / Windows Service) | **OPEN** |
