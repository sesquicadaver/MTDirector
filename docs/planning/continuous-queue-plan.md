...
W7-220 AUDIT-AN-02 — Analysis fingerprint CAS must use controller-computed value **OPEN**
W7-221 Seed next PLAN-26 row after AUDIT-AN-02 → AUDIT-DIFF-01 **OPEN**
...
| 250 | W7-220 | [#845](https://github.com/sesquicadaver/MTDirector/issues/845) | AUDIT-AN-02 — Analysis fingerprint CAS must use controller-computed value | **OPEN** |
| 251 | W7-221 | [#846](https://github.com/sesquicadaver/MTDirector/issues/846) | Seed next PLAN-26 row after AUDIT-AN-02 → AUDIT-DIFF-01 | **OPEN** |
