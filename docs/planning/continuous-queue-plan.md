...
**PLAN-44 (Controller OpenTelemetry tracing):** [`plan-44-controller-otel-tracing.md`](plan-44-controller-otel-tracing.md) inventory **W7-320 (#1047) DONE**; seed **W7-321 (#1048) DONE**; implement **W7-322 (#1050) DONE**; COMPLETE **W7-323 (#1052) OPEN** (**§3.C NEXT**); seeded by **W7-319 DONE** after **PLAN-43 COMPLETE**
