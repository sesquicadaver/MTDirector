...
**PLAN-29 (Desktop connection health / reconnect after Controller stop):** [`plan-29-desktop-connection-health-reconnect.md`](plan-29-desktop-connection-health-reconnect.md) inventory **W7-250 (#907) DONE**; seed **W7-251 DONE**; implement **W7-252 DONE**; seed **W7-253 (#911) OPEN** (**§3.C NEXT** → DESK-CONN-RECONNECT-01)
...
W7-253 Seed next PLAN-29 row after DESK-CONN-HEALTH-01 → DESK-CONN-RECONNECT-01 **OPEN** (**§3.C NEXT**)
