...
W7-226 AUDIT-DEP-01 — Background recovery must not race active deployment **OPEN**
W7-227 Seed next PLAN-26 row after AUDIT-DEP-01 → AUDIT-DEP-02 **OPEN**
...
| 256 | W7-226 | [#859](https://github.com/sesquicadaver/MTDirector/issues/859) | AUDIT-DEP-01 — Background recovery must not race active deployment | **OPEN** |
| 257 | W7-227 | [#860](https://github.com/sesquicadaver/MTDirector/issues/860) | Seed next PLAN-26 row after AUDIT-DEP-01 → AUDIT-DEP-02 | **OPEN** |
