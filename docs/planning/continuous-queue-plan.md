...
**PLAN-29 (Desktop connection health / reconnect after Controller stop):** [`plan-29-desktop-connection-health-reconnect.md`](plan-29-desktop-connection-health-reconnect.md) inventory **W7-250 (#907) DONE**; seed **W7-251 DONE**; implement **W7-252 (#910) OPEN** (**§3.C NEXT**); seed **W7-253 (#911) OPEN**
...
W7-252 DESK-CONN-HEALTH-01 — Connected-state periodic gRPC health probe after Controller stop **OPEN** (**§3.C NEXT**)
