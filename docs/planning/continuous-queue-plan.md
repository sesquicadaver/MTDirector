...
| DESK-A11Y-POLICY-OBJ-02 — Policies catalog/object Names + ack/record + authoring residual + lifecycle + shell/Incident Names regression Living Spec | Desktop / Avalonia | **W7-197 OPEN** |
...
W7-197 DESK-A11Y-POLICY-OBJ-02 — Policies catalog/object Names + ack/record + authoring residual + lifecycle + shell/Incident Names regression Living Spec **OPEN**
...
| 227 | W7-197 | [#797](https://github.com/sesquicadaver/MTDirector/issues/797) | DESK-A11Y-POLICY-OBJ-02 — Policies catalog/object Names + ack/record + authoring residual + lifecycle + shell/Incident Names regression Living Spec | **OPEN** |
