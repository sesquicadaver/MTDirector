...
**PLAN-43 (Controller metrics/OpenTelemetry):** [`plan-43-controller-http-metrics-otel.md`](plan-43-controller-http-metrics-otel.md) inventory **W7-316 (#1039) DONE**; seed **W7-317 (#1040) DONE**; implement **W7-318 (#1042) OPEN** (**§3.C NEXT**); COMPLETE **W7-319 (#1044) OPEN**; seeded by **W7-315 DONE** after **PLAN-42 COMPLETE**
