...
**PLAN-37 (Controller host env sample packaging):** [`plan-37-controller-host-env-sample-packaging.md`](plan-37-controller-host-env-sample-packaging.md) inventory **W7-292 (#991) DONE**; seed **W7-293 (#992) DONE**; implement **W7-294 (#994) OPEN** (**§3.C NEXT**); COMPLETE **W7-295 (#996) OPEN**; seeded by **W7-291 DONE** after **PLAN-36 COMPLETE**
...
| 324 | W7-294 | [#994](https://github.com/sesquicadaver/MTDirector/issues/994) | OPS-HOST-ENV-01 — author mfc-controller.env.example + docs + package-controller bundle | **OPEN** |
| 325 | W7-295 | [#996](https://github.com/sesquicadaver/MTDirector/issues/996) | Seed next after OPS-HOST-ENV-01 (PLAN-37 COMPLETE) | **OPEN** |
