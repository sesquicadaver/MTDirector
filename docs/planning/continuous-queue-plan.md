...
W7-214 AUDIT-CAP-01 — Canonical filter must include firewall match fields **OPEN**
W7-215 Seed next PLAN-26 row after AUDIT-CAP-01 → AUDIT-CAP-02 **OPEN**
...
| 244 | W7-214 | [#833](https://github.com/sesquicadaver/MTDirector/issues/833) | AUDIT-CAP-01 — Canonical filter must include firewall match fields | **OPEN** |
| 245 | W7-215 | [#834](https://github.com/sesquicadaver/MTDirector/issues/834) | Seed next PLAN-26 row after AUDIT-CAP-01 → AUDIT-CAP-02 | **OPEN** |
