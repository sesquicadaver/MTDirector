...
**PLAN-29 (Desktop connection health / reconnect after Controller stop):** [`plan-29-desktop-connection-health-reconnect.md`](plan-29-desktop-connection-health-reconnect.md) seed **W7-249 DONE**; inventory **W7-250 (#907) OPEN** (**§3.C NEXT**); seed **W7-251 (#908) OPEN**
...
W7-250 PLAN-29 — Inventory Desktop connection health / reconnect after Controller stop (AUDIT §18 residual) **OPEN** (**§3.C NEXT**)
W7-251 Seed first PLAN-29 atomic row after inventory → DESK-CONN-HEALTH-01 **OPEN**
...
| 280 | W7-250 | [#907](https://github.com/sesquicadaver/MTDirector/issues/907) | PLAN-29 — Inventory Desktop connection health / reconnect after Controller stop (AUDIT §18 residual) | **OPEN** |
