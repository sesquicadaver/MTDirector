...
| DESK-A11Y-POLICY-ACK-02 — Policies ack/record Names + authoring residual + lifecycle + shell/Incident Names regression Living Spec | Desktop / Avalonia | **W7-192 OPEN** |
...
W7-192 DESK-A11Y-POLICY-ACK-02 — Policies ack/record Names + authoring residual + lifecycle + shell/Incident Names regression Living Spec **OPEN**
...
| 222 | W7-192 | [#787](https://github.com/sesquicadaver/MTDirector/issues/787) | DESK-A11Y-POLICY-ACK-02 — Policies ack/record Names + authoring residual + lifecycle + shell/Incident Names regression Living Spec | **OPEN** |
