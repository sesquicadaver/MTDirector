...
**PLAN-42 (Controller HTTP health probes):** [`plan-42-controller-http-health-probes.md`](plan-42-controller-http-health-probes.md) inventory **W7-312 (#1031) DONE**; seed **W7-313 (#1032) OPEN** (**§3.C NEXT**); implement **W7-314 (#1034) OPEN**; seeded by **W7-311 DONE** after **PLAN-41 COMPLETE**
...
| 343 | W7-313 | [#1032](https://github.com/sesquicadaver/MTDirector/issues/1032) | Seed first PLAN-42 atomic row after inventory → CTRL-HTTP-HEALTH-01 | **OPEN** |
