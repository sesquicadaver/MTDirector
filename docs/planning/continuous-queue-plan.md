...
**PLAN-48 (Controller Kestrel request-body / HTTP2 limits):** [`plan-48-controller-kestrel-request-body-limits.md`](plan-48-controller-kestrel-request-body-limits.md) inventory **W7-336 (#1079) DONE**; seed **W7-337 (#1080) DONE**; implement **CTRL-KESTREL-BODY-01 W7-338 (#1082) DONE**; COMPLETE **W7-339 (#1084) OPEN** (**§3.C NEXT**); seeded by **W7-335 DONE** after **PLAN-47 COMPLETE**
