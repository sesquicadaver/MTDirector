...
**PLAN-43 (Controller metrics/OpenTelemetry):** [`plan-43-controller-http-metrics-otel.md`](plan-43-controller-http-metrics-otel.md) inventory **W7-316 (#1039) OPEN** (**§3.C NEXT**); seed **W7-317 (#1040) OPEN**; seeded by **W7-315 DONE** after **PLAN-42 COMPLETE**
**PLAN-42 (Controller HTTP health probes):** [`plan-42-controller-http-health-probes.md`](plan-42-controller-http-health-probes.md) inventory **W7-312 (#1031) DONE**; seed **W7-313 (#1032) DONE**; implement **W7-314 (#1034) DONE**; COMPLETE **W7-315 (#1036) DONE**; successor **PLAN-43** inventory **W7-316 OPEN**; seeded by **W7-311 DONE** after **PLAN-41 COMPLETE**
...
| 346 | W7-316 | [#1039](https://github.com/sesquicadaver/MTDirector/issues/1039) | PLAN-43 — Inventory Controller metrics/OpenTelemetry beyond HTTP health probes | **OPEN** |
