...
**PLAN-37 (Controller host env sample packaging):** [`plan-37-controller-host-env-sample-packaging.md`](plan-37-controller-host-env-sample-packaging.md) inventory **W7-292 (#991) DONE**; seed **W7-293 (#992) DONE**; implement **W7-294 (#994) DONE**; COMPLETE **W7-295 (#996) OPEN** (**§3.C NEXT**); seeded by **W7-291 DONE** after **PLAN-36 COMPLETE**
