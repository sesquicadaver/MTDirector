...
**PLAN-34 (Desktop operator launch packaging templates):** [`plan-34-desktop-operator-launch-packaging.md`](plan-34-desktop-operator-launch-packaging.md) inventory **W7-278 (#963) DONE**; seed **W7-279 (#964) OPEN** (**§3.C NEXT**); implement **W7-280 (#966) OPEN**; WIN seed **W7-281 (#967) OPEN**; seeded by **W7-277 DONE** after **PLAN-33 COMPLETE**
...
| 309 | W7-279 | [#964](https://github.com/sesquicadaver/MTDirector/issues/964) | Seed first PLAN-34 atomic row after inventory → DESK-HOST-LINUX-01 | **OPEN** |
| 310 | W7-280 | [#966](https://github.com/sesquicadaver/MTDirector/issues/966) | DESK-HOST-LINUX-01 — freedesktop .desktop template for framework-dependent Desktop | **OPEN** |
| 311 | W7-281 | [#967](https://github.com/sesquicadaver/MTDirector/issues/967) | Seed next PLAN-34 row after DESK-HOST-LINUX-01 → DESK-HOST-WIN-01 | **OPEN** |
