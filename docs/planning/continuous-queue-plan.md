...
W7-222 AUDIT-DIFF-01 — Semantic policy diff must surface reachability change **OPEN**
W7-223 Seed next PLAN-26 row after AUDIT-DIFF-01 → AUDIT-GUARD-01 **OPEN**
...
| 252 | W7-222 | [#849](https://github.com/sesquicadaver/MTDirector/issues/849) | AUDIT-DIFF-01 — Semantic policy diff must surface reachability change | **OPEN** |
| 253 | W7-223 | [#850](https://github.com/sesquicadaver/MTDirector/issues/850) | Seed next PLAN-26 row after AUDIT-DIFF-01 → AUDIT-GUARD-01 | **OPEN** |
