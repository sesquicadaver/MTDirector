...
**PLAN-60 (Desktop service RPC fault text):** [`plan-60-desktop-service-rpc-fault-text.md`](plan-60-desktop-service-rpc-fault-text.md) inventory **W7-384 (#1175) DONE**; seed **W7-385 (#1176) DONE**; implement **DESK-SVC-FAULT-01 W7-386 (#1178) DONE**; COMPLETE **W7-387 (#1179) OPEN** (**§3.C NEXT**); seeded by **W7-383 (#1171) DONE** after **PLAN-59 COMPLETE**
