...
**PLAN-38 (Controller host sysusers/tmpfiles packaging):** [`plan-38-controller-host-sysusers-tmpfiles-packaging.md`](plan-38-controller-host-sysusers-tmpfiles-packaging.md) inventory **W7-296 (#999) OPEN** (**§3.C NEXT**); seed **W7-297 (#1000) OPEN**; seeded by **W7-295 DONE** after **PLAN-37 COMPLETE**; seeded by **W7-291 DONE** after **PLAN-36 COMPLETE**
...
| 326 | W7-296 | [#999](https://github.com/sesquicadaver/MTDirector/issues/999) | PLAN-38 — Inventory Controller host sysusers/tmpfiles packaging (mfc user + /etc/mfc + /var/lib/mfc) | **OPEN** |
