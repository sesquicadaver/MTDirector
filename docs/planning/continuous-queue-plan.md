...
**PLAN-25 (Desktop Inventory / Zones / Add-router AutomationProperties):** [`plan-25-desktop-inventory-zones-add-router-automation.md`](plan-25-desktop-inventory-zones-add-router-automation.md) inventory **OPEN** (W7-204)  
...
| PLAN-25 — Inventory next Desktop Living Spec product tranche after PLAN-24 | Docs / PLAN-25 | **W7-204 OPEN** |
...
W7-204 PLAN-25 — Inventory next Desktop Living Spec product tranche after PLAN-24 **OPEN**
...
| 234 | W7-204 | [#810](https://github.com/sesquicadaver/MTDirector/issues/810) | PLAN-25 — Inventory next Desktop Living Spec product tranche after PLAN-24 | **OPEN** |
