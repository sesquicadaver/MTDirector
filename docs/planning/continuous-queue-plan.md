...
**PLAN-29 (Desktop connection health / reconnect after Controller stop):** [`plan-29-desktop-connection-health-reconnect.md`](plan-29-desktop-connection-health-reconnect.md) inventory **W7-250 (#907) DONE**; seed **W7-251 (#908) OPEN** (**§3.C NEXT** → DESK-CONN-HEALTH-01); implement **W7-252 (#910) OPEN**; seed **W7-253 (#911) OPEN**
...
W7-251 Seed first PLAN-29 atomic row after inventory → DESK-CONN-HEALTH-01 **OPEN** (**§3.C NEXT**)
W7-252 DESK-CONN-HEALTH-01 — Connected-state periodic gRPC health probe after Controller stop **OPEN**
W7-253 Seed next PLAN-29 row after DESK-CONN-HEALTH-01 → DESK-CONN-RECONNECT-01 **OPEN**
...
| 281 | W7-251 | [#908](https://github.com/sesquicadaver/MTDirector/issues/908) | Seed first PLAN-29 atomic row after inventory → DESK-CONN-HEALTH-01 | **OPEN** |
| 282 | W7-252 | [#910](https://github.com/sesquicadaver/MTDirector/issues/910) | DESK-CONN-HEALTH-01 — Connected-state periodic gRPC health probe after Controller stop | **OPEN** |
| 283 | W7-253 | [#911](https://github.com/sesquicadaver/MTDirector/issues/911) | Seed next PLAN-29 row after DESK-CONN-HEALTH-01 → DESK-CONN-RECONNECT-01 | **OPEN** |
