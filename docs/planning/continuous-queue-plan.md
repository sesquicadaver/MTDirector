...
**PLAN-44 (Controller OpenTelemetry tracing):** [`plan-44-controller-otel-tracing.md`](plan-44-controller-otel-tracing.md) inventory **W7-320 (#1047) DONE**; seed **W7-321 (#1048) OPEN** (**§3.C NEXT**); implement **W7-322 (#1050) OPEN**; seeded by **W7-319 DONE** after **PLAN-43 COMPLETE**
...
| 351 | W7-321 | [#1048](https://github.com/sesquicadaver/MTDirector/issues/1048) | Seed first PLAN-44 atomic row after inventory → CTRL-HTTP-OTEL-TRACE-01 | **OPEN** |
