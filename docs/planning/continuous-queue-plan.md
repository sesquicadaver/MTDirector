...
**PLAN-48 (Controller Kestrel request-body / HTTP2 limits):** [`plan-48-controller-kestrel-request-body-limits.md`](plan-48-controller-kestrel-request-body-limits.md) inventory **W7-336 (#1079) DONE**; seed **W7-337 (#1080) OPEN** (**§3.C NEXT**); implement **W7-338 (#1082) OPEN**; seeded by **W7-335 DONE** after **PLAN-47 COMPLETE**
**PLAN-47 (Controller gRPC message-size / transport limits):** [`plan-47-controller-grpc-message-size-limits.md`](plan-47-controller-grpc-message-size-limits.md) **COMPLETE** (inventory **W7-332 (#1071) DONE**; seed **W7-333 (#1072) DONE**; implement **CTRL-GRPC-MSGSIZE-01 W7-334 (#1074) DONE**; COMPLETE **W7-335 (#1076) DONE**; successor **PLAN-48** inventory **W7-336 DONE**; seed **W7-337 OPEN**; seeded by **W7-331 DONE** after **PLAN-46 COMPLETE**
