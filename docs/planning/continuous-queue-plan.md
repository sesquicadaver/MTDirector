...
**PLAN-37 (Controller host env sample packaging):** [`plan-37-controller-host-env-sample-packaging.md`](plan-37-controller-host-env-sample-packaging.md) inventory **W7-292 (#991) OPEN** (**§3.C NEXT**); seed **W7-293 (#992) OPEN**; seeded by **W7-291 DONE** after **PLAN-36 COMPLETE**
...
| 322 | W7-292 | [#991](https://github.com/sesquicadaver/MTDirector/issues/991) | PLAN-37 — Inventory Controller host env sample packaging (mfc-controller.env.example for EnvironmentFile) | **OPEN** |
