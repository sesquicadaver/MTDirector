...
**PLAN-25 (Desktop Inventory / Zones / Add-router AutomationProperties):** [`plan-25-desktop-inventory-zones-add-router-automation.md`](plan-25-desktop-inventory-zones-add-router-automation.md) **COMPLETE** (W7-209); **NEXT = W7-205 (#814)** PLAN-26 seed  
