...
**PLAN-31 (Desktop residual ListBox / Drift–Audit read-only a11y):** [`plan-31-desktop-residual-listbox-readonly-a11y.md`](plan-31-desktop-residual-listbox-readonly-a11y.md) inventory **W7-262 (#931) DONE**; seed **W7-263 (#932) DONE**; implement **W7-264 (#934) DONE**; seed **W7-265 (#935) OPEN** (**§3.C NEXT**) → DESK-A11Y-RO-01; seeded by **W7-261 DONE** after **PLAN-30 COMPLETE**
