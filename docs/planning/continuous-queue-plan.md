...
**PLAN-52 (Desktop gRPC ErrorDetail operator mapping):** [`plan-52-desktop-grpc-error-detail.md`](plan-52-desktop-grpc-error-detail.md) inventory **W7-352 (#1111) DONE**; seed **W7-353 (#1112) DONE**; implement **DESK-RPC-FAULT-01 W7-354 (#1114) DONE**; COMPLETE **W7-355 (#1115) OPEN** (**§3.C NEXT**); seeded by **W7-351 DONE** after **PLAN-51 COMPLETE**
