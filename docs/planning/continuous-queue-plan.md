...
W7-216 AUDIT-CAP-02 — Required-section read failure must not complete snapshot **OPEN**
W7-217 Seed next PLAN-26 row after AUDIT-CAP-02 → AUDIT-AN-01 **OPEN**
...
| 246 | W7-216 | [#837](https://github.com/sesquicadaver/MTDirector/issues/837) | AUDIT-CAP-02 — Required-section read failure must not complete snapshot | **OPEN** |
| 247 | W7-217 | [#838](https://github.com/sesquicadaver/MTDirector/issues/838) | Seed next PLAN-26 row after AUDIT-CAP-02 → AUDIT-AN-01 | **OPEN** |
