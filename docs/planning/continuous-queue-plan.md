...
**PLAN-46 (Controller OpenTelemetry resource identity):** [`plan-46-controller-otel-resource-identity.md`](plan-46-controller-otel-resource-identity.md) inventory **W7-328 (#1063) DONE**; seed **W7-329 (#1064) OPEN** (**§3.C NEXT**); implement **W7-330 (#1066) OPEN**; seeded by **W7-327 DONE** after **PLAN-45 COMPLETE**
