...
**PLAN-42 (Controller HTTP health probes):** [`plan-42-controller-http-health-probes.md`](plan-42-controller-http-health-probes.md) inventory **W7-312 (#1031) OPEN** (**§3.C NEXT**); seed **W7-313 (#1032) OPEN**; seeded by **W7-311 DONE** after **PLAN-41 COMPLETE**
...
| 342 | W7-312 | [#1031](https://github.com/sesquicadaver/MTDirector/issues/1031) | PLAN-42 — Inventory Controller HTTP liveness/readiness probes beyond gRPC health | **OPEN** |
