...
**Status:** Seed **W7-205 DONE**; Inventory **DONE** (W7-206); **AUDIT-RULE-01 DONE** (W7-210); seed **W7-211 DONE**; **AUDIT-CTX-01 DONE** (W7-212); seed **W7-213 DONE**; next **W7-214 (#833)** AUDIT-CAP-01; seed **W7-215 (#834)** → AUDIT-CAP-02  
...
| 3 | **AUDIT-CAP-01** | Canonical filter omits firewall match fields (§01) | `DiscoveryCanonicalProjector.ProjectOrderedFilter` | **W7-214 (#833)**; seed **W7-215 (#834)** |
...
8. Execute ranks 3…14 atomically starting at **AUDIT-CAP-01**.

## §3.C NEXT

**§3.C NEXT = W7-214 (#833)** — AUDIT-CAP-01 Canonical filter must include firewall match fields.
