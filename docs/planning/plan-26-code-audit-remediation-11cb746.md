...
| 10 | **AUDIT-DEP-02** | Watchdog uses Controller clock + fixed TTL (§08); cleanup result ignored (§09) | `RouterOsDeploymentRuntime`, `RecoverDeploymentUseCase` | **W7-228 (#863)**; seed **W7-229 (#864)** |
...
22. Execute ranks 10…14 atomically starting at **W7-228** → **AUDIT-DEP-02**.

## §3.C NEXT

**§3.C NEXT = W7-228 (#863)** — AUDIT-DEP-02 — Watchdog durable clock/TTL; cleanup result must not be ignored.
