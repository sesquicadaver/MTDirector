...
**Status:** Seed **W7-205 DONE**; Inventory **DONE** (W7-206); **AUDIT-RULE-01 DONE** (W7-210); seed **W7-211 DONE**; **AUDIT-CTX-01 DONE** (W7-212); seed **W7-213 DONE**; **AUDIT-CAP-01 DONE** (W7-214); seed **W7-215 DONE**; **AUDIT-CAP-02 DONE** (W7-216); next **W7-217 (#838)** seed → AUDIT-AN-01  
...
| 4 | **AUDIT-CAP-02** | Required-section read failure can complete snapshot (§02) | `RouterOsDiscoveryReader`, `SnapshotCaptureResultBuilder`, `RequiredSectionCaptureGate` | **W7-216 (#837) DONE**; seed **W7-217 (#838)** |
...
11. Execute ranks 5…14 atomically starting at seed **W7-217** → AUDIT-AN-01.

## §3.C NEXT

**§3.C NEXT = W7-217 (#838)** — Seed next PLAN-26 row after AUDIT-CAP-02 → AUDIT-AN-01.
