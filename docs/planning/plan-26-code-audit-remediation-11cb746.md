...
| 7 | **AUDIT-DIFF-01** | Semantic policy diff can hide reachability change (§06) | `PolicyRevisionDiffer` | **W7-222 (#849)**; seed **W7-223 (#850)** |
...
16. Execute ranks 7…14 atomically starting at **AUDIT-DIFF-01**.

## §3.C NEXT

**§3.C NEXT = W7-222 (#849)** — AUDIT-DIFF-01 Semantic policy diff must surface reachability change.
