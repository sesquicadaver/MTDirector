...
**Status:** Inventory **DONE** (W7-388); seed **W7-389 (#1184) OPEN** (**§3.C NEXT**); implement **W7-390 (#1186) OPEN**; COMPLETE seed **W7-391 (#1187) OPEN**; predecessor **PLAN-60 COMPLETE**  
...
|------|----|-----|----------|-------|
| 1 | **DESK-CONN-DISC-01** | Store `DesktopRpcFaultText.Format` when those `Disconnected` catches are `RpcException`; keep `ex.Message` otherwise + Living Spec | **2** `Disconnected` `ex.Message` assignments @ `994863c1` (seed baseline `33682bb6`) | after inventory **W7-388 DONE**; seed **W7-389 (#1184) OPEN**; implement **W7-390 (#1186) OPEN**; COMPLETE **W7-391 (#1187) OPEN** |
...
**§3.C NEXT = W7-389 (#1184)** — Seed first PLAN-61 atomic row after inventory → DESK-CONN-DISC-01.
