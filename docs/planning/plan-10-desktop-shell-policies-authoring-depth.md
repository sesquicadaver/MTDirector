...
| Policies Diff | presence in DESK-POLICY-01 Ac2/Ac5; `PoliciesViewModelTests` | PLAN-10 (**DESK-DIFF-01** next) |
...
| 2 | **DESK-DIFF-01** | Policies Diff execute path lacks dedicated Desktop Living Spec depth | `PoliciesViewModel.DiffCommand`; `IPolicyPanelService.DiffAsync` | **W7-108 OPEN** (#614); seeded by **W7-107 DONE** (#612) |
...
**§3.C NEXT = W7-108 (#614)** — DESK-DIFF-01 Desktop Policies Diff Living Spec depth.
