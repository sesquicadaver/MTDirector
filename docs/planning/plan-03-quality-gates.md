...
| 4 | **QG-LIVESPEC-MATRIX-01** | Living Spec matrix update-in-PR is process text; optional gate | ROADMAP §5 | **W7-55 OPEN** (#508) |
...
**§3.C NEXT = W7-55 (#508)** — QG-LIVESPEC-MATRIX-01 Living Spec matrix PR gate.
