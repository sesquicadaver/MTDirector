...
| [`planning/plan-22-desktop-policies-ack-record-automation.md`](planning/plan-22-desktop-policies-ack-record-automation.md) | PLAN-22: Desktop Policies acknowledge/record-analysis AutomationProperties (inventory **DONE**) |
