...
| [`planning/plan-24-desktop-onboarding-deployment-automation.md`](planning/plan-24-desktop-onboarding-deployment-automation.md) | PLAN-24: Desktop Onboarding/Deployment AutomationProperties (inventory **DONE**) |
