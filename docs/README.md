...
**Next delivery (§3):** **W5-01** ([#342](https://github.com/sesquicadaver/MTDirector/issues/342)) — [`planning/continuous-queue-plan.md`](planning/continuous-queue-plan.md).  
...
| [`development/desktop-ui-backend-alignment.md`](development/desktop-ui-backend-alignment.md) | Desktop UI ↔ Controller data alignment (P0–P3); **NEXT = W5-01** |
