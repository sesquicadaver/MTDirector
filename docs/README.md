...
**Next delivery (§3):** **§3.C NEXT = residual (CRS lab ops)** — W5-03 ([#344](https://github.com/sesquicadaver/MTDirector/issues/344)) **DONE**. CRS/physical lab runner stays ops.  
...
| [`development/desktop-ui-backend-alignment.md`](development/desktop-ui-backend-alignment.md) | Desktop UI ↔ Controller data alignment (P0–P3); W5.c **DONE**; residual CRS lab ops |
