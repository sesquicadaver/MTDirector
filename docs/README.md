...
| [`planning/plan-17-desktop-incident-bind-action-automation.md`](planning/plan-17-desktop-incident-bind-action-automation.md) | PLAN-17: Desktop Incident bind-action AutomationProperties (inventory **OPEN**) |
