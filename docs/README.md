...
| [`planning/plan-18-desktop-incident-ingest-action-automation.md`](planning/plan-18-desktop-incident-ingest-action-automation.md) | PLAN-18: Desktop Incident ingest-action AutomationProperties (inventory **DONE**) |
