...
| [`planning/plan-19-desktop-shell-connect-disconnect-automation.md`](planning/plan-19-desktop-shell-connect-disconnect-automation.md) | PLAN-19: Desktop shell Connect/Disconnect AutomationProperties (inventory **OPEN**) |
