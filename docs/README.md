...
| [`planning/plan-13-desktop-layout-density.md`](planning/plan-13-desktop-layout-density.md) | PLAN-13: Desktop layout density Living Spec tranche (inventory **DONE**) |
