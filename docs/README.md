...
| [`planning/plan-16-desktop-incident-automation-properties.md`](planning/plan-16-desktop-incident-automation-properties.md) | PLAN-16: Desktop Incident AutomationProperties accessible-name (inventory **DONE**) |
