...
**Next delivery (§3):** **§3.C NEXT = W7-71 (#540)** — W7-70 ([#538](https://github.com/sesquicadaver/MTDirector/issues/538)) **DONE**; PLAN-05 **COMPLETE**. CRS/physical lab runner stays ops.  
...
| [`planning/continuous-queue-plan.md`](planning/continuous-queue-plan.md) | PLAN-02 continuous §3.C + PLAN-03…PLAN-05 |
...
| [`planning/plan-05-desktop-operator-surface.md`](planning/plan-05-desktop-operator-surface.md) | PLAN-05: Desktop operator-surface Living Spec tranche |
