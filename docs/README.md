...
**Next delivery (§3):** **§3.C NEXT = W7-97 (#593)** — W7-96 ([#590](https://github.com/sesquicadaver/MTDirector/issues/590)) **DONE**; PLAN-08 **COMPLETE** ([`plan-08-desktop-secondary-operator-surface.md`](planning/plan-08-desktop-secondary-operator-surface.md)); PLAN-07 **COMPLETE**; PLAN-06 **COMPLETE**; PLAN-05 **COMPLETE**. CRS/physical lab runner stays ops.  
