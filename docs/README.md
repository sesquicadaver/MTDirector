...
**Next delivery (§3):** **§3.C NEXT = residual (CRS lab ops)** — W6-01 ([#352](https://github.com/sesquicadaver/MTDirector/issues/352)) **DONE**. CRS/physical lab runner stays ops.  
...
| [`development/desktop-ui-backend-alignment.md`](development/desktop-ui-backend-alignment.md) | Desktop UI ↔ Controller data alignment (P0–P3); W6-01 **DONE**; residual CRS lab ops |
