...
**Next delivery (§3):** **CONT-02** ([#341](https://github.com/sesquicadaver/MTDirector/issues/341)) — [`planning/continuous-queue-plan.md`](planning/continuous-queue-plan.md).  
...
| [`development/desktop-ui-backend-alignment.md`](development/desktop-ui-backend-alignment.md) | Desktop UI ↔ Controller data alignment (P0–P3); **NEXT = CONT-02** |
