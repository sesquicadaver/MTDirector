...
**Next delivery (§3):** **§3.C NEXT = W7-96 (#590)** — W7-95 ([#589](https://github.com/sesquicadaver/MTDirector/issues/589)) **DONE**; PLAN-07 **COMPLETE**; PLAN-08 inventory ([`plan-08-desktop-secondary-operator-surface.md`](planning/plan-08-desktop-secondary-operator-surface.md)); PLAN-06 **COMPLETE**; PLAN-05 **COMPLETE**. CRS/physical lab runner stays ops.  
