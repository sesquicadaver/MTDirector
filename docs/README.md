...
| [`planning/plan-25-desktop-inventory-zones-add-router-automation.md`](planning/plan-25-desktop-inventory-zones-add-router-automation.md) | PLAN-25: Desktop Inventory/Zones AutomationProperties (inventory **DONE**; INV-01 DONE; NEXT seed INV-02) |
