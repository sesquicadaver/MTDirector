...
**Next delivery (§3):** **§3.C NEXT = W7-93 (#585)** — W7-92 ([#582](https://github.com/sesquicadaver/MTDirector/issues/582)) **DONE**; PLAN-07 **COMPLETE**; PLAN-08 inventory ([`plan-08-desktop-secondary-operator-surface.md`](planning/plan-08-desktop-secondary-operator-surface.md)); PLAN-06 **COMPLETE**; PLAN-05 **COMPLETE**. CRS/physical lab runner stays ops.  
